/*
 * config.h - Xbox 360 (PowerPC) configuration for libmad 0.15.1b
 *
 * Based on the MSVC++ config.h from the original libmad distribution,
 * adapted for the Xbox 360 SDK (MSVC targeting PPC / big-endian).
 */
