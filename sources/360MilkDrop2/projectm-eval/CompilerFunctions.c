...
{
    prjm_eval_compiler_arg_node_t* arg_node = (prjm_eval_compiler_arg_node_t *)calloc(1, sizeof(prjm_eval_compiler_arg_node_t));
    ...
    if (!arglist)
    {
        arglist = (prjm_eval_compiler_arg_list_t *)calloc(1, sizeof(prjm_eval_compiler_arg_list_t));
        if (!arglist)
        {
            free(arg_node);
            return NULL;
...
{
    prjm_eval_exptreenode_t* expr = (prjm_eval_exptreenode_t *)calloc(1, sizeof(prjm_eval_exptreenode_t));

    expr->func = func->func;

    prjm_eval_compiler_node_t* node = (prjm_eval_compiler_node_t *)calloc(1, sizeof(prjm_eval_compiler_node_t));
                                                               ...
                                                               prjm_eval_compiler_arg_list_t* arglist)
{
    ...
    {
        expr->args = (prjm_eval_exptreenode **)calloc(arglist->count + 1, sizeof(prjm_eval_exptreenode_t*));
    ...
    {
        prjm_eval_exptreenode_t* const_expr = (prjm_eval_exptreenode_t *)calloc(1, sizeof(prjm_eval_exptreenode_t));
                                                             ...
                                                             prjm_eval_compiler_node_t* instruction)
{
    ...
    if (list->type != PRJM_EVAL_NODE_FUNC_INSTRUCTIONLIST)
    {
        ...
        new_node->tree_node->list = (prjm_eval_exptreenode_list_item_t *)malloc(sizeof(prjm_eval_exptreenode_list_item_t));
    ...
    item->next = (prjm_eval_exptreenode_list_item *)malloc(sizeof(prjm_eval_exptreenode_list_item_t));
