...
{
    prjm_eval_compiler_context_t* cctx = (prjm_eval_compiler_context_t *)calloc(1, sizeof(prjm_eval_compiler_context_t));
    ...
    for (int index = intrinsics_count - 1; index >= 0; --index)
    {
        ...
        prjm_eval_function_list_item_t* func = (prjm_eval_function_list_item_t *)malloc(sizeof(prjm_eval_function_list_item_t));
        func->function = (prjm_eval_function_def_t *)malloc(sizeof(prjm_eval_function_def_t));
...
prjm_eval_program_t* prjm_eval_compile_code(prjm_eval_compiler_context_t* cctx, const char* code)
{
    ...
    prjm_eval_program_t* program = (prjm_eval_program_t *)malloc(sizeof(prjm_eval_program_t));
    program->cctx = cctx;
