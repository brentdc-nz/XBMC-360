...
static void PREFIX_h264_qpel16_h_lowpass_altivec(uint8_t * dst, uint8_t * src, int dstStride, int srcStride) {
    ...
    LOAD_ZERO;
    const vec_u8 permM2 = __lvx(-2, src);
    const vec_u8 permM1 = __lvx(-1, src);
    const vec_u8 permP0 = __lvx(+0, src);
    const vec_u8 permP1 = __lvx(+1, src);
    ...
    for (i = 0 ; i < 16 ; i ++) {
        vec_u8 srcR1 = __lvx(-2, src);
        vec_u8 srcR2 = __lvx(14, src);

        switch (align) {
        default: {
            srcM2 = __vperm(srcR1, srcR2, permM2);
            srcM1 = __vperm(srcR1, srcR2, permM1);
            srcP0 = __vperm(srcR1, srcR2, permP0);
            srcP1 = __vperm(srcR1, srcR2, permP1);
            srcP2 = __vperm(srcR1, srcR2, permP2);
            srcP3 = __vperm(srcR1, srcR2, permP3);
        } break;
        case 11: {
            srcM2 = __vperm(srcR1, srcR2, permM2);
            srcM1 = __vperm(srcR1, srcR2, permM1);
        ...
        case 12: {
            vec_u8 srcR3 = __lvx(30, src);
            srcM2 = __vperm(srcR1, srcR2, permM2);
            srcM1 = __vperm(srcR1, srcR2, permM1);
            srcP0 = __vperm(srcR1, srcR2, permP0);
            srcP1 = __vperm(srcR1, srcR2, permP1);
            srcP2 = srcR2;
            srcP3 = __vperm(srcR2, srcR3, permP3);
        } break;
        case 13: {
            vec_u8 srcR3 = __lvx(30, src);
            srcM2 = __vperm(srcR1, srcR2, permM2);
            ...
            srcP0 = __vperm(srcR1, srcR2, permP0);
            srcP1 = srcR2;
            srcP2 = __vperm(srcR2, srcR3, permP2);
            srcP3 = __vperm(srcR2, srcR3, permP3);
        } break;
        case 14: {
            vec_u8 srcR3 = __lvx(30, src);
            ...
            srcM1 = __vperm(srcR1, srcR2, permM1);
            srcP0 = srcR2;
            srcP1 = __vperm(srcR2, srcR3, permP1);
            srcP2 = __vperm(srcR2, srcR3, permP2);
            srcP3 = __vperm(srcR2, srcR3, permP3);
        } break;
        case 15: {
            ...
            srcM2 = __vperm(srcR1, srcR2, permM2);
            srcM1 = srcR2;
            srcP0 = __vperm(srcR2, srcR3, permP0);
            srcP1 = __vperm(srcR2, srcR3, permP1);
            srcP2 = __vperm(srcR2, srcR3, permP2);
            srcP3 = __vperm(srcR2, srcR3, permP3);
        } break;
...
static void PREFIX_h264_qpel16_v_lowpass_altivec(uint8_t * dst, uint8_t * src, int dstStride, int srcStride) {
    ...
    const vec_u8 srcM2a = __lvx(0, srcbis);
    const vec_u8 srcM2b = __lvx(16, srcbis);
    const vec_u8 srcM2 = __vperm(srcM2a, srcM2b, perm);
    //srcbis += srcStride;
    const vec_u8 srcM1a = __lvx(0, srcbis += srcStride);
    const vec_u8 srcM1b = __lvx(16, srcbis);
    const vec_u8 srcM1 = __vperm(srcM1a, srcM1b, perm);
    //srcbis += srcStride;
    const vec_u8 srcP0a = __lvx(0, srcbis += srcStride);
    const vec_u8 srcP0b = __lvx(16, srcbis);
    const vec_u8 srcP0 = __vperm(srcP0a, srcP0b, perm);
    //srcbis += srcStride;
    const vec_u8 srcP1a = __lvx(0, srcbis += srcStride);
    const vec_u8 srcP1b = __lvx(16, srcbis);
    const vec_u8 srcP1 = __vperm(srcP1a, srcP1b, perm);
    //srcbis += srcStride;
    const vec_u8 srcP2a = __lvx(0, srcbis += srcStride);
    const vec_u8 srcP2b = __lvx(16, srcbis);
    const vec_u8 srcP2 = __vperm(srcP2a, srcP2b, perm);
    //srcbis += srcStride;
    ...
    for (i = 0 ; i < 16 ; i++) {
        srcP3a = __lvx(0, srcbis += srcStride);
        srcP3b = __lvx(16, srcbis);
        srcP3 = __vperm(srcP3a, srcP3b, perm);
...
static void PREFIX_h264_qpel16_hv_lowpass_altivec(uint8_t * dst, int16_t * tmp, uint8_t * src, int dstStride, int tmpStride, int srcStride) {
    ...
    tmpM2ssA = __lvx(tmpbis,0);
    tmpM2ssB = __lvx(tmpbis,16);
    tmpbis += tmpStride;
    tmpM1ssA = __lvx(tmpbis,0);
    tmpM1ssB = __lvx(tmpbis,16);
    tmpbis += tmpStride;
    tmpP0ssA = __lvx(tmpbis,0);
    tmpP0ssB = __lvx(tmpbis,16);
    tmpbis += tmpStride;
    tmpP1ssA = __lvx(tmpbis,0);
    tmpP1ssB = __lvx(tmpbis,16);
    tmpbis += tmpStride;
    tmpP2ssA = __lvx(tmpbis,0);
    tmpP2ssB = __lvx(tmpbis,16);
    tmpbis += tmpStride;

    for (i = 0 ; i < 16 ; i++) {
        const vec_s16 tmpP3ssA = __lvx(tmpbis, 0);
        const vec_s16 tmpP3ssB = __lvx(tmpbis ,16);
