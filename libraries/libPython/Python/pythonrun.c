...
#ifdef _XBOX
    /* Xbox 360: No filesystem stdlib available, set streams to None */
...
#ifdef _XBOX
    /* On Xbox 360, we use utf-8 statically set in bltinmodule.c.
       Skip codec lookup since the encodings package is not available. */
