...
#  include <xtl.h>
#  include <winsockx.h>
/* Xbox 360 CRT's getenv() calls RIP() and crashes.
   Must be defined AFTER xtl.h/stdlib.h so the declaration isn't mangled. */
#  undef getenv
...
#if defined(_MSC_VER) && !defined(__POCC__) && !defined(_XBOX)
...
#define LIBIDN_REQUIRED_VERSION "0.4.1"
    ...
    defined(USE_DARWINSSL) || defined(USE_GSKIT) || defined(USE_MBEDTLS)
