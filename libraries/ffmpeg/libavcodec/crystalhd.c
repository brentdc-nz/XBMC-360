    ...
    *got_frame = 0;
    ...
    if (ret == BC_STS_FMT_CHANGE) {
        ...
        case vdecAspectRatioSquare:
            avctx->sample_aspect_ratio = av_make_q(1, 1);
            break;
        case vdecAspectRatio12_11:
            avctx->sample_aspect_ratio = av_make_q(12, 11);
            break;
        case vdecAspectRatio10_11:
            avctx->sample_aspect_ratio = av_make_q(10, 11);
            break;
        case vdecAspectRatio16_11:
            avctx->sample_aspect_ratio = av_make_q(16, 11);
            break;
        case vdecAspectRatio40_33:
            avctx->sample_aspect_ratio = av_make_q(40, 33);
            break;
        case vdecAspectRatio24_11:
            avctx->sample_aspect_ratio = av_make_q(24, 11);
            break;
        case vdecAspectRatio20_11:
            avctx->sample_aspect_ratio = av_make_q(20, 11);
            break;
        case vdecAspectRatio32_11:
            avctx->sample_aspect_ratio = av_make_q(32, 11);
            break;
        case vdecAspectRatio80_33:
            avctx->sample_aspect_ratio = av_make_q(80, 33);
            break;
        case vdecAspectRatio18_11:
            avctx->sample_aspect_ratio = av_make_q(18, 11);
            break;
        case vdecAspectRatio15_11:
            avctx->sample_aspect_ratio = av_make_q(15, 11);
            break;
        case vdecAspectRatio64_33:
            avctx->sample_aspect_ratio = av_make_q(64, 33);
            break;
        case vdecAspectRatio160_99:
            avctx->sample_aspect_ratio = av_make_q(160, 99);
            break;
        case vdecAspectRatio4_3:
            avctx->sample_aspect_ratio = av_make_q(4, 3);
            break;
        case vdecAspectRatio16_9:
            avctx->sample_aspect_ratio = av_make_q(16, 9);
            break;
        case vdecAspectRatio221_1:
            avctx->sample_aspect_ratio = av_make_q(221, 1);
            break;
        }
...
static const enum AVPixelFormat _ff_crystalhd_fmts_31[] = { AV_PIX_FMT_YUYV422, AV_PIX_FMT_NONE };
AVCodec ff_h264_crystalhd_decoder = {
        "h264_crystalhd", /* name */
        NULL_IF_CONFIG_SMALL("H.264 / AVC / MPEG-4 AVC / MPEG-4 part 10 (CrystalHD acceleration)"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_H264, /* id */
        CODEC_CAP_DR1 | CODEC_CAP_DELAY, /* capabilities */
        0, /* supported_framerates */
        _ff_crystalhd_fmts_31, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        &h264_class, /* priv_class */
        0, /* profiles */
        sizeof(CHDContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
...
static const enum AVPixelFormat _ff_crystalhd_fmts_32[] = { AV_PIX_FMT_YUYV422, AV_PIX_FMT_NONE };
AVCodec ff_mpeg2_crystalhd_decoder = {
        "mpeg2_crystalhd", /* name */
        NULL_IF_CONFIG_SMALL("MPEG-2 Video (CrystalHD acceleration)"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_MPEG2VIDEO, /* id */
        CODEC_CAP_DR1 | CODEC_CAP_DELAY, /* capabilities */
        0, /* supported_framerates */
        _ff_crystalhd_fmts_32, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        &mpeg2_class, /* priv_class */
        0, /* profiles */
        sizeof(CHDContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
...
static const enum AVPixelFormat _ff_crystalhd_fmts_33[] = { AV_PIX_FMT_YUYV422, AV_PIX_FMT_NONE };
AVCodec ff_mpeg4_crystalhd_decoder = {
        "mpeg4_crystalhd", /* name */
        NULL_IF_CONFIG_SMALL("MPEG-4 Part 2 (CrystalHD acceleration)"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_MPEG4, /* id */
        CODEC_CAP_DR1 | CODEC_CAP_DELAY, /* capabilities */
        0, /* supported_framerates */
        _ff_crystalhd_fmts_33, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        &mpeg4_class, /* priv_class */
        0, /* profiles */
        sizeof(CHDContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
...
static const enum AVPixelFormat _ff_crystalhd_fmts_34[] = { AV_PIX_FMT_YUYV422, AV_PIX_FMT_NONE };
AVCodec ff_msmpeg4_crystalhd_decoder = {
        "msmpeg4_crystalhd", /* name */
        NULL_IF_CONFIG_SMALL("MPEG-4 Part 2 Microsoft variant version 3 (CrystalHD acceleration)"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_MSMPEG4V3, /* id */
        CODEC_CAP_DR1 | CODEC_CAP_DELAY | CODEC_CAP_EXPERIMENTAL, /* capabilities */
        0, /* supported_framerates */
        _ff_crystalhd_fmts_34, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        &msmpeg4_class, /* priv_class */
        0, /* profiles */
        sizeof(CHDContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
...
static const enum AVPixelFormat _ff_crystalhd_fmts_35[] = { AV_PIX_FMT_YUYV422, AV_PIX_FMT_NONE };
AVCodec ff_vc1_crystalhd_decoder = {
        "vc1_crystalhd", /* name */
        NULL_IF_CONFIG_SMALL("SMPTE VC-1 (CrystalHD acceleration)"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_VC1, /* id */
        CODEC_CAP_DR1 | CODEC_CAP_DELAY, /* capabilities */
        0, /* supported_framerates */
        _ff_crystalhd_fmts_35, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        &vc1_class, /* priv_class */
        0, /* profiles */
        sizeof(CHDContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
...
static const enum AVPixelFormat _ff_crystalhd_fmts_36[] = { AV_PIX_FMT_YUYV422, AV_PIX_FMT_NONE };
AVCodec ff_wmv3_crystalhd_decoder = {
        "wmv3_crystalhd", /* name */
        NULL_IF_CONFIG_SMALL("Windows Media Video 9 (CrystalHD acceleration)"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_WMV3, /* id */
        CODEC_CAP_DR1 | CODEC_CAP_DELAY, /* capabilities */
        0, /* supported_framerates */
        _ff_crystalhd_fmts_36, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        &wmv3_class, /* priv_class */
        0, /* profiles */
        sizeof(CHDContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
