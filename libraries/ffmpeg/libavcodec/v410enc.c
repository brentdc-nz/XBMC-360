...
static const enum AVPixelFormat _ff_v410enc_fmts_158[] = { AV_PIX_FMT_YUV444P10, AV_PIX_FMT_NONE };
AVCodec ff_v410_encoder = {
        ...
        0, /* defaults */
        0, /* init_static_data */
        v410_encode_init, /* init */
        0, /* encode_sub */
        v410_encode_frame, /* encode2 */
        0, /* decode */
        v410_encode_close, /* close */
    };
