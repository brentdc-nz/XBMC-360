...
static const enum AVSampleFormat _ff_mpc8_fmts_95[] = { AV_SAMPLE_FMT_S16P,
                                                      AV_SAMPLE_FMT_NONE };
AVCodec ff_mpc8_decoder = {
        ...
        0, /* defaults */
        0, /* init_static_data */
        mpc8_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        mpc8_decode_frame, /* decode */
        0, /* close */
        mpc8_decode_flush, /* flush */
    };
