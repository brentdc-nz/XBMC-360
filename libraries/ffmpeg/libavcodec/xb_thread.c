...
/**
 * @file
 * Xbox 360 multithreading support functions
 * Adapted from FFmpeg 1.2 pthread.c for Xbox 360 XDK
 ...
 * Thread 0 is typically used by the system, so we start at thread 1.
 */
