...
static const enum AVSampleFormat _ff_libvo_aacenc_fmts_80[] = { AV_SAMPLE_FMT_S16,
                                                     AV_SAMPLE_FMT_NONE };
AVCodec ff_libvo_aacenc_encoder = {
        "libvo_aacenc", /* name */
        NULL_IF_CONFIG_SMALL("Android VisualOn AAC (Advanced Audio Coding)"), /* long_name */
        AVMEDIA_TYPE_AUDIO, /* type */
        AV_CODEC_ID_AAC, /* id */
        CODEC_CAP_SMALL_LAST_FRAME | CODEC_CAP_DELAY, /* capabilities */
        0, /* supported_framerates */
        0, /* pix_fmts */
        mpeg4audio_sample_rates, /* supported_samplerates */
        _ff_libvo_aacenc_fmts_80, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
