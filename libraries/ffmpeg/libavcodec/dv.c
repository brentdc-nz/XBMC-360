...
static const enum AVPixelFormat _ff_dv_fmts_41[] = { AV_PIX_FMT_YUV411P, AV_PIX_FMT_YUV422P, AV_PIX_FMT_YUV420P, AV_PIX_FMT_NONE };
AVCodec ff_dvvideo_encoder = {
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(DVVideoContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        dvvideo_init_encoder, /* init */
        0, /* encode_sub */
        dvvideo_encode_frame, /* encode2 */
    };
