...
static const AVClass snowenc_class = {
        "snow encoder", /* class_name */
        av_default_item_name, /* item_name */
        options, /* option */
        LIBAVUTIL_VERSION_INT, /* version */
    };

static const enum AVPixelFormat _ff_snowenc_fmts_144[] = { AV_PIX_FMT_YUV420P, AV_PIX_FMT_YUV410P, AV_PIX_FMT_YUV444P,
        AV_PIX_FMT_NONE };
AVCodec ff_snow_encoder = {
        ...
        _ff_snowenc_fmts_144, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        &snowenc_class, /* priv_class */
        0, /* profiles */
        sizeof(SnowContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
