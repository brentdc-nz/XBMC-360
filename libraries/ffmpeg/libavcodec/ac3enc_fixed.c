...
static const AVClass ac3enc_class = {
        "Fixed-Point AC-3 Encoder", /* class_name */
...
static const enum AVSampleFormat _ff_ac3enc_fixed_fmts_11[] = { AV_SAMPLE_FMT_S16P,
                                                      AV_SAMPLE_FMT_NONE };
AVCodec ff_ac3_fixed_encoder = {
        ...
        _ff_ac3enc_fixed_fmts_11, /* sample_fmts */
        ...
        0, /* init_static_data */
        ac3_fixed_encode_init, /* init */
        0, /* encode_sub */
        ff_ac3_fixed_encode_frame, /* encode2 */
        0, /* decode */
