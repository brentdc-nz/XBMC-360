...
static const enum AVSampleFormat _ff_wmalosslessdec_fmts_168[] = { AV_SAMPLE_FMT_S16P,
                                                      AV_SAMPLE_FMT_S32P,
                                                      AV_SAMPLE_FMT_NONE };
AVCodec ff_wmalossless_decoder = {
        ...
        CODEC_CAP_SUBFRAMES | CODEC_CAP_DR1 | CODEC_CAP_DELAY, /* capabilities */
        0, /* supported_framerates */
        0, /* pix_fmts */
        0, /* supported_samplerates */
        _ff_wmalosslessdec_fmts_168, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof(WmallDecodeCtx), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
