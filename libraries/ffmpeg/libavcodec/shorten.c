...
static const enum AVSampleFormat _ff_shorten_fmts_143[] = { AV_SAMPLE_FMT_S16P,
                                                      AV_SAMPLE_FMT_U8P,
                                                      AV_SAMPLE_FMT_NONE };
AVCodec ff_shorten_decoder = {
        ...
        _ff_shorten_fmts_143, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof(ShortenContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        shorten_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        shorten_decode_frame, /* decode */
        shorten_decode_close, /* close */
    };
