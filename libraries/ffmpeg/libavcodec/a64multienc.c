...
static const enum AVPixelFormat _ff_a64multienc_fmts_3[] = { AV_PIX_FMT_GRAY8, AV_PIX_FMT_NONE };
AVCodec ff_a64multi_encoder = {
        ...
        _ff_a64multienc_fmts_3, /* pix_fmts */
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(A64Context), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        a64multi_init_encoder, /* init */
        0, /* encode_sub */
        a64multi_encode_frame, /* encode2 */
        0, /* decode */
        a64multi_close_encoder, /* close */
    };
#endif
#if CONFIG_A64MULTI5_ENCODER
static const enum AVPixelFormat _ff_a64multienc_fmts_4[] = { AV_PIX_FMT_GRAY8, AV_PIX_FMT_NONE };
AVCodec ff_a64multi5_encoder = {
        ...
        CODEC_CAP_DELAY, /* capabilities */
        0, /* supported_framerates */
        _ff_a64multienc_fmts_4, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
