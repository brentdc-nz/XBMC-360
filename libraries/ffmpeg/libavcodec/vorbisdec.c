...
static const enum AVSampleFormat _ff_vorbisdec_fmts_162[] = { AV_SAMPLE_FMT_FLTP,
                                                       AV_SAMPLE_FMT_NONE };
AVCodec ff_vorbis_decoder = {
        ...
        _ff_vorbisdec_fmts_162, /* sample_fmts */
        ff_vorbis_channel_layouts, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof(vorbis_context), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        vorbis_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        vorbis_decode_frame, /* decode */
        vorbis_decode_close, /* close */
        vorbis_decode_flush, /* flush */
    };
