...
static const enum AVSampleFormat _ff_libmp3lame_fmts_71[] = { AV_SAMPLE_FMT_S32P,
                                                             AV_SAMPLE_FMT_FLTP,
                                                             AV_SAMPLE_FMT_S16P,
                                                             AV_SAMPLE_FMT_NONE };
AVCodec ff_libmp3lame_encoder = {
        "libmp3lame", /* name */
        NULL_IF_CONFIG_SMALL("libmp3lame MP3 (MPEG audio layer 3)"), /* long_name */
        AVMEDIA_TYPE_AUDIO, /* type */
        AV_CODEC_ID_MP3, /* id */
        CODEC_CAP_DELAY | CODEC_CAP_SMALL_LAST_FRAME, /* capabilities */
        0, /* supported_framerates */
        0, /* pix_fmts */
        libmp3lame_sample_rates, /* supported_samplerates */
        _ff_libmp3lame_fmts_71, /* sample_fmts */
        (const uint64_t[]) { AV_CH_LAYOUT_MONO,
                                                  AV_CH_LAYOUT_STEREO,
                                                  0 }, /* channel_layouts */
        0, /* max_lowres */
        &libmp3lame_class, /* priv_class */
        0, /* profiles */
        sizeof(LAMEContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        libmp3lame_defaults, /* defaults */
        0, /* init_static_data */
        mp3lame_encode_init, /* init */
        0, /* encode_sub */
        mp3lame_encode_frame, /* encode2 */
        0, /* decode */
        mp3lame_encode_close, /* close */
    };
