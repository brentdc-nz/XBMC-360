...
static int oggvorbis_decode_init(AVCodecContext *avccontext) {
    ...
    avccontext->time_base= av_make_q(1, avccontext->sample_rate);
...
AVCodec ff_libvorbis_decoder = {
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(OggVorbisDecContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        oggvorbis_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        oggvorbis_decode_frame, /* decode */
        oggvorbis_decode_close, /* close */
    };
