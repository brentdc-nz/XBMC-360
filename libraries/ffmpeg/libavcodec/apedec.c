...
static const AVClass ape_decoder_class = {
        "APE decoder", /* class_name */
        av_default_item_name, /* item_name */
        options, /* option */
        LIBAVUTIL_VERSION_INT, /* version */
    };

static const enum AVSampleFormat _ff_apedec_fmts_18[] = { AV_SAMPLE_FMT_U8P,
                                                      AV_SAMPLE_FMT_S16P,
                                                      AV_SAMPLE_FMT_S32P,
                                                      AV_SAMPLE_FMT_NONE };
AVCodec ff_ape_decoder = {
        ...
        AV_CODEC_ID_APE, /* id */
        CODEC_CAP_SUBFRAMES | CODEC_CAP_DELAY | CODEC_CAP_DR1, /* capabilities */
        0, /* supported_framerates */
        0, /* pix_fmts */
        0, /* supported_samplerates */
        _ff_apedec_fmts_18, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        &ape_decoder_class, /* priv_class */
        0, /* profiles */
        sizeof(APEContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        ape_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        ape_decode_frame, /* decode */
        ape_decode_close, /* close */
        ape_flush, /* flush */
    };
