...
AVHWAccel ff_mpeg2_dxva2_hwaccel = {
        ...
        AV_PIX_FMT_DXVA2_VLD, /* pix_fmt */
        0, /* capabilities */
        0, /* next */
        dxva2_mpeg2_start_frame, /* start_frame */
        dxva2_mpeg2_decode_slice, /* decode_slice */
        dxva2_mpeg2_end_frame, /* end_frame */
        sizeof(struct dxva2_picture_context), /* priv_data_size */
    };
