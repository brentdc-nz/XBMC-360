...
static const enum AVPixelFormat _ff_xbmenc_fmts_171[] = { AV_PIX_FMT_MONOWHITE,
                                                   AV_PIX_FMT_NONE };
AVCodec ff_xbm_encoder = {
        ...
        0, /* defaults */
        0, /* init_static_data */
        xbm_encode_init, /* init */
        0, /* encode_sub */
        xbm_encode_frame, /* encode2 */
        0, /* decode */
        xbm_encode_close, /* close */
    };
