...
static const enum AVSampleFormat _ff_roqaudioenc_fmts_138[] = { AV_SAMPLE_FMT_S16,
                                                     AV_SAMPLE_FMT_NONE };
AVCodec ff_roq_dpcm_encoder = {
        "roq_dpcm", /* name */
        NULL_IF_CONFIG_SMALL("id RoQ DPCM"), /* long_name */
        ...
        _ff_roqaudioenc_fmts_138, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof(ROQDPCMContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        roq_dpcm_encode_init, /* init */
        0, /* encode_sub */
        roq_dpcm_encode_frame, /* encode2 */
        0, /* decode */
        roq_dpcm_encode_close, /* close */
    };
