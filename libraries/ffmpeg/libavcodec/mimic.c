...
AVCodec ff_mimic_decoder = {
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(MimicContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        ONLY_IF_THREADS_ENABLED(mimic_decode_update_thread_context), /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        mimic_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        mimic_decode_frame, /* decode */
        mimic_decode_end, /* close */
    };
