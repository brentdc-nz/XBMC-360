...
static const enum AVPixelFormat _ff_flashsv_fmts_46[] = { AV_PIX_FMT_BGR24, AV_PIX_FMT_NONE };
AVCodec ff_flashsv_decoder = {
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(FlashSVContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        flashsv_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        flashsv_decode_frame, /* decode */
        flashsv_decode_end, /* close */
    };
...
static const enum AVPixelFormat _ff_flashsv_fmts_47[] = { AV_PIX_FMT_BGR24, AV_PIX_FMT_NONE };
AVCodec ff_flashsv2_decoder = {
        ...
        0, /* defaults */
        0, /* init_static_data */
        flashsv2_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        flashsv_decode_frame, /* decode */
        flashsv2_decode_end, /* close */
    };
