...
static const enum AVPixelFormat _ff_gif_fmts_54[] = { AV_PIX_FMT_RGB8, AV_PIX_FMT_BGR8, AV_PIX_FMT_RGB4_BYTE, AV_PIX_FMT_BGR4_BYTE,
...
AVCodec ff_gif_encoder = {
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(GIFContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        gif_encode_init, /* init */
        0, /* encode_sub */
        gif_encode_frame, /* encode2 */
        0, /* decode */
        gif_encode_close, /* close */
    };
