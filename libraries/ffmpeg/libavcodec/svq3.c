...
static const enum AVPixelFormat _ff_svq3_fmts_148[] = { AV_PIX_FMT_YUVJ420P,
                                                     AV_PIX_FMT_NONE };
AVCodec ff_svq3_decoder = {
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(SVQ3Context), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        svq3_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        svq3_decode_frame, /* decode */
        svq3_decode_end, /* close */
    };
