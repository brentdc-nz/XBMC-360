...
static const enum AVSampleFormat _ff_wmaenc_fmts_166[] = { AV_SAMPLE_FMT_FLTP,
                                                     AV_SAMPLE_FMT_NONE };
AVCodec ff_wmav1_encoder = {
        ...
        _ff_wmaenc_fmts_166, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        ...
        encode_init, /* init */
        0, /* encode_sub */
        encode_superframe, /* encode2 */
        0, /* decode */
        ff_wma_end, /* close */
    };
#endif
#if CONFIG_WMAV2_ENCODER
static const enum AVSampleFormat _ff_wmaenc_fmts_167[] = { AV_SAMPLE_FMT_FLTP,
                                                     AV_SAMPLE_FMT_NONE };
AVCodec ff_wmav2_encoder = {
        ...
        0, /* pix_fmts */
        0, /* supported_samplerates */
        _ff_wmaenc_fmts_167, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
