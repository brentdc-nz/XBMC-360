...
static int find_frame_rate_index(MpegEncContext *s){
    int i;
    AVRational bestq= av_make_q(0, 0);
    AVRational ext;
...
#define COMMON_OPTS\
    { "gop_timecode",        "MPEG GOP Timecode in hh:mm:ss[:;.]ff format", OFFSET(tc_opt_str), AV_OPT_TYPE_STRING, {0}, CHAR_MIN, CHAR_MAX, VE },\
...
static const enum AVPixelFormat _ff_mpeg12enc_fmts_96[] = { AV_PIX_FMT_YUV420P,
                                                        AV_PIX_FMT_NONE };
AVCodec ff_mpeg1video_encoder = {
        ...
        CODEC_CAP_DELAY | CODEC_CAP_SLICE_THREADS, /* capabilities */
        ff_mpeg12_frame_rate_tab + 1, /* supported_framerates */
        _ff_mpeg12enc_fmts_96, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        &mpeg1_class, /* priv_class */
        0, /* profiles */
...
static const enum AVPixelFormat _ff_mpeg12enc_fmts_97[] = { AV_PIX_FMT_YUV420P, AV_PIX_FMT_YUV422P, AV_PIX_FMT_NONE };
AVCodec ff_mpeg2video_encoder = {
        ...
        CODEC_CAP_DELAY | CODEC_CAP_SLICE_THREADS, /* capabilities */
        ff_mpeg2_frame_rate_tab, /* supported_framerates */
        _ff_mpeg12enc_fmts_97, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
