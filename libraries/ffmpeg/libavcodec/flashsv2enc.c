...
static const enum AVPixelFormat _ff_flashsv2enc_fmts_48[] = { AV_PIX_FMT_BGR24, AV_PIX_FMT_NONE };
AVCodec ff_flashsv2_encoder = {
        "flashsv2", /* name */
        NULL_IF_CONFIG_SMALL("Flash Screen Video Version 2"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_FLASHSV2, /* id */
        0, /* capabilities */
        0, /* supported_framerates */
        _ff_flashsv2enc_fmts_48, /* pix_fmts */
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(FlashSV2Context), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        flashsv2_encode_init, /* init */
        0, /* encode_sub */
        flashsv2_encode_frame, /* encode2 */
        0, /* decode */
        flashsv2_encode_end, /* close */
    };
