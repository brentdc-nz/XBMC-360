...
AVCodec ff_movtext_encoder = {
        "mov_text", /* name */
        NULL_IF_CONFIG_SMALL("3GPP Timed Text subtitle"), /* long_name */
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(MovTextContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        mov_text_encode_init, /* init */
        mov_text_encode_frame, /* encode_sub */
        0, /* encode2 */
        0, /* decode */
        mov_text_encode_close, /* close */
    };
