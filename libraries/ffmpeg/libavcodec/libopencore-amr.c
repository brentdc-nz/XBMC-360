...
AVCodec ff_libopencore_amrnb_decoder = {
        "libopencore_amrnb", /* name */
        NULL_IF_CONFIG_SMALL("OpenCORE AMR-NB (Adaptive Multi-Rate Narrow-Band)"), /* long_name */
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(AMRContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        amr_nb_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        amr_nb_decode_frame, /* decode */
        amr_nb_decode_close, /* close */
    };
...
static const enum AVSampleFormat _ff_libopencore_amr_fmts_72[] = { AV_SAMPLE_FMT_S16,
                                                     AV_SAMPLE_FMT_NONE };
AVCodec ff_libopencore_amrnb_encoder = {
        ...
        0, /* pix_fmts */
        0, /* supported_samplerates */
        _ff_libopencore_amr_fmts_72, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        &class, /* priv_class */
        0, /* profiles */
        ...
        0, /* defaults */
        0, /* init_static_data */
        amr_nb_encode_init, /* init */
        0, /* encode_sub */
        amr_nb_encode_frame, /* encode2 */
        0, /* decode */
        amr_nb_encode_close, /* close */
    };
...
AVCodec ff_libopencore_amrwb_decoder = {
        "libopencore_amrwb", /* name */
        NULL_IF_CONFIG_SMALL("OpenCORE AMR-WB (Adaptive Multi-Rate Wide-Band)"), /* long_name */
        AVMEDIA_TYPE_AUDIO, /* type */
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(AMRWBContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        amr_wb_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        amr_wb_decode_frame, /* decode */
        amr_wb_decode_close, /* close */
    };
