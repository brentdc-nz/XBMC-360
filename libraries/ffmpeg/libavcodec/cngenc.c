...
static const enum AVSampleFormat _ff_cngenc_fmts_29[] = { AV_SAMPLE_FMT_S16,
                                                     AV_SAMPLE_FMT_NONE };
AVCodec ff_comfortnoise_encoder = {
        ...
        _ff_cngenc_fmts_29, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        ...
        0, /* defaults */
        0, /* init_static_data */
        cng_encode_init, /* init */
        0, /* encode_sub */
        cng_encode_frame, /* encode2 */
        0, /* decode */
        cng_encode_close, /* close */
    };
