...
static const enum AVPixelFormat _ff_libxvid_fmts_87[] = { AV_PIX_FMT_YUV420P, AV_PIX_FMT_NONE };
AVCodec ff_libxvid_encoder = {
        "libxvid", /* name */
        NULL_IF_CONFIG_SMALL("libxvidcore MPEG-4 part 2"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_MPEG4, /* id */
        0, /* capabilities */
        0, /* supported_framerates */
        _ff_libxvid_fmts_87, /* pix_fmts */
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(struct xvid_context), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        xvid_encode_init, /* init */
        0, /* encode_sub */
        xvid_encode_frame, /* encode2 */
        0, /* decode */
        xvid_encode_close, /* close */
    };
