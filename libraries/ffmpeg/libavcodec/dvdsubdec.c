...
static const AVOption options[] = {
    { "palette", "set the global palette", OFFSET(palette_str), AV_OPT_TYPE_STRING, {0}, 0, 0, VD },
    { NULL }
};
static const AVClass class = {
        "dvdsubdec", /* class_name */
...
AVCodec ff_dvdsub_decoder = {
        ...
        &class, /* priv_class */
        0, /* profiles */
        sizeof(DVDSubContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
