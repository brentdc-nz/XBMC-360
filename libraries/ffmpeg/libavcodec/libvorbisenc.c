...
static const AVOption options[] = {
    { "iblock", "Sets the impulse block bias", offsetof(OggVorbisEncContext, iblock), AV_OPT_TYPE_DOUBLE, { 0 }, -15, 0, AV_OPT_FLAG_AUDIO_PARAM | AV_OPT_FLAG_ENCODING_PARAM },
    { NULL }
};
...
static const enum AVSampleFormat _ff_libvorbisenc_fmts_83[] = { AV_SAMPLE_FMT_FLTP,
                                                      AV_SAMPLE_FMT_NONE };
AVCodec ff_libvorbis_encoder = {
        "libvorbis", /* name */
        NULL_IF_CONFIG_SMALL("libvorbis"), /* long_name */
        ...
        _ff_libvorbisenc_fmts_83, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        &class, /* priv_class */
        0, /* profiles */
        sizeof(OggVorbisEncContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        defaults, /* defaults */
        0, /* init_static_data */
        oggvorbis_encode_init, /* init */
        0, /* encode_sub */
        oggvorbis_encode_frame, /* encode2 */
        0, /* decode */
        oggvorbis_encode_close, /* close */
    };
