...
static const AVOption options[] = {
    ...
    { "vendor", "vendor ID", OFFSET(vendor),
        AV_OPT_TYPE_STRING, { 0 }, CHAR_MIN, CHAR_MAX, VE },
...
static const AVClass proresenc_class = {
        "ProRes encoder", /* class_name */
        av_default_item_name, /* item_name */
        options, /* option */
        LIBAVUTIL_VERSION_INT, /* version */
    };

static const enum AVPixelFormat _ff_proresenc_kostya_fmts_131[] = { AV_PIX_FMT_YUV422P10, AV_PIX_FMT_YUV444P10, AV_PIX_FMT_NONE };
AVCodec ff_prores_kostya_encoder = {
        ...
        _ff_proresenc_kostya_fmts_131, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        &proresenc_class, /* priv_class */
        0, /* profiles */
