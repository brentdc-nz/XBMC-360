...
AVCodecParser ff_dvdsub_parser = {
        { AV_CODEC_ID_DVD_SUBTITLE }, /* codec_ids */
        sizeof(DVDSubParseContext), /* priv_data_size */
        dvdsub_parse_init, /* parser_init */
        dvdsub_parse, /* parser_parse */
        dvdsub_parse_close, /* parser_close */
    };
