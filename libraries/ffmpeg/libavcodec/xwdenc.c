...
static const enum AVPixelFormat _ff_xwdenc_fmts_174[] = { AV_PIX_FMT_BGRA,
                                                 AV_PIX_FMT_RGBA,
                                                 AV_PIX_FMT_ARGB,
                                                 AV_PIX_FMT_ABGR,
                                                 AV_PIX_FMT_RGB24,
...
AVCodec ff_xwd_encoder = {
        ...
        0, /* defaults */
        0, /* init_static_data */
        xwd_encode_init, /* init */
        0, /* encode_sub */
        xwd_encode_frame, /* encode2 */
        0, /* decode */
        xwd_encode_close, /* close */
    };
