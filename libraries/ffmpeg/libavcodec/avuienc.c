...
static const enum AVPixelFormat _ff_avuienc_fmts_25[] = { AV_PIX_FMT_UYVY422, AV_PIX_FMT_NONE };
AVCodec ff_avui_encoder = {
        ...
        0, /* defaults */
        0, /* init_static_data */
        avui_encode_init, /* init */
        0, /* encode_sub */
        avui_encode_frame, /* encode2 */
        0, /* decode */
        avui_encode_close, /* close */
    };
