...
static const enum AVSampleFormat _ff_ra144enc_fmts_136[] = { AV_SAMPLE_FMT_S16,
                                                     AV_SAMPLE_FMT_NONE };
AVCodec ff_ra_144_encoder = {
        ...
        0, /* pix_fmts */
        static const int _cla_ra144enc_1[] = {8000, 0};
        _cla_ra144enc_1, /* supported_samplerates */
        _ff_ra144enc_fmts_136, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof(RA144Context), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        ra144_encode_init, /* init */
        0, /* encode_sub */
        ra144_encode_frame, /* encode2 */
        0, /* decode */
        ra144_encode_close, /* close */
    };
