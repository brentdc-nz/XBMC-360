...
static const enum AVSampleFormat _ff_eac3enc_fmts_42[] = { AV_SAMPLE_FMT_FLTP,
                                                      AV_SAMPLE_FMT_NONE };
AVCodec ff_eac3_encoder = {
        "eac3", /* name */
        NULL_IF_CONFIG_SMALL("ATSC A/52 E-AC-3"), /* long_name */
        ...
        _ff_eac3enc_fmts_42, /* sample_fmts */
        ff_ac3_channel_layouts, /* channel_layouts */
        0, /* max_lowres */
        &eac3enc_class, /* priv_class */
        0, /* profiles */
