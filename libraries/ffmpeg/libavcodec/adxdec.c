...
static const enum AVSampleFormat _ff_adxdec_fmts_13[] = { AV_SAMPLE_FMT_S16P,
                                                      AV_SAMPLE_FMT_NONE };
AVCodec ff_adpcm_adx_decoder = {
        ...
        _ff_adxdec_fmts_13, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof(ADXContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        adx_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        adx_decode_frame, /* decode */
        0, /* close */
        adx_decode_flush, /* flush */
    };
