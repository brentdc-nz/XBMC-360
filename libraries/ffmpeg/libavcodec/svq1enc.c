...
static const enum PixelFormat _ff_svq1enc_fmts_147[] = { AV_PIX_FMT_YUV410P,
                                                   AV_PIX_FMT_NONE };
AVCodec ff_svq1_encoder = {
        ...
        0, /* defaults */
        0, /* init_static_data */
        svq1_encode_init, /* init */
        0, /* encode_sub */
        svq1_encode_frame, /* encode2 */
        0, /* decode */
        svq1_encode_end, /* close */
    };
