...
static const AVOption options[] = {
    { "password", "Set decoding password", OFFSET(pass), AV_OPT_TYPE_STRING, {0}, 0, 0, DEC },
    { NULL },
};

static const AVClass tta_decoder_class = {
        "TTA Decoder", /* class_name */
...
AVCodec ff_tta_decoder = {
        ...
        0, /* channel_layouts */
        0, /* max_lowres */
        &tta_decoder_class, /* priv_class */
        0, /* profiles */
        sizeof(TTAContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        tta_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        tta_decode_frame, /* decode */
        tta_decode_close, /* close */
    };
