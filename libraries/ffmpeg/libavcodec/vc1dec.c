...
AVCodec ff_vc1_decoder = {
        ...
        vc1_hwaccel_pixfmt_list_420, /* pix_fmts */
        ...
        sizeof(VC1Context), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        vc1_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        vc1_decode_frame, /* decode */
        ff_vc1_decode_end, /* close */
        ff_mpeg_flush, /* flush */
    };
...
static const enum AVPixelFormat _ff_vc1dec_fmts_159[] = { AV_PIX_FMT_VDPAU_WMV3, AV_PIX_FMT_NONE };
AVCodec ff_wmv3_vdpau_decoder = {
        "wmv3_vdpau", /* name */
        NULL_IF_CONFIG_SMALL("Windows Media Video 9 VDPAU"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_WMV3, /* id */
        CODEC_CAP_DR1 | CODEC_CAP_DELAY | CODEC_CAP_HWACCEL_VDPAU, /* capabilities */
        0, /* supported_framerates */
        _ff_vc1dec_fmts_159, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
...
#if CONFIG_VC1_VDPAU_DECODER
static const enum AVPixelFormat _ff_vc1dec_fmts_160[] = { AV_PIX_FMT_VDPAU_VC1, AV_PIX_FMT_NONE };
AVCodec ff_vc1_vdpau_decoder = {
        "vc1_vdpau", /* name */
        NULL_IF_CONFIG_SMALL("SMPTE VC-1 VDPAU"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_VC1, /* id */
        CODEC_CAP_DR1 | CODEC_CAP_DELAY | CODEC_CAP_HWACCEL_VDPAU, /* capabilities */
        0, /* supported_framerates */
        _ff_vc1dec_fmts_160, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
