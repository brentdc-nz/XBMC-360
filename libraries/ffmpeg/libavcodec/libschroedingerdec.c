...
AVCodec ff_libschroedinger_decoder = {
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(SchroDecoderParams), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        libschroedinger_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        libschroedinger_decode_frame, /* decode */
        libschroedinger_decode_close, /* close */
        libschroedinger_flush, /* flush */
    };
