...
static const enum AVSampleFormat _ff_cook_fmts_30[] = { AV_SAMPLE_FMT_FLTP,
                                                      AV_SAMPLE_FMT_NONE };
AVCodec ff_cook_decoder = {
        ...
        _ff_cook_fmts_30, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof(COOKContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        cook_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        cook_decode_frame, /* decode */
        cook_decode_close, /* close */
    };
