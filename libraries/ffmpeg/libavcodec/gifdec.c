...
static const AVClass decoder_class = {
        ...
        0, /* child_next */
        0, /* child_class_next */
        AV_CLASS_CATEGORY_DECODER, /* category */
    };
...
AVCodec ff_gif_decoder = {
        ...
        0, /* channel_layouts */
        0, /* max_lowres */
        &decoder_class, /* priv_class */
        0, /* profiles */
        sizeof(GifState), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        gif_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        gif_decode_frame, /* decode */
        gif_decode_close, /* close */
    };
