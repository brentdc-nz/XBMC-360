...
static const enum AVSampleFormat _ff_adxenc_fmts_14[] = { AV_SAMPLE_FMT_S16,
                                                      AV_SAMPLE_FMT_NONE };
AVCodec ff_adpcm_adx_encoder = {
        ...
        _ff_adxenc_fmts_14, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        ...
        0, /* defaults */
        0, /* init_static_data */
        adx_encode_init, /* init */
        0, /* encode_sub */
        adx_encode_frame, /* encode2 */
        0, /* decode */
        adx_encode_close, /* close */
    };
