...
static const enum AVSampleFormat _ff_libaacplus_fmts_64[] = { AV_SAMPLE_FMT_S16,
                                                     AV_SAMPLE_FMT_NONE };
AVCodec ff_libaacplus_encoder = {
        "libaacplus", /* name */
        NULL_IF_CONFIG_SMALL("libaacplus AAC+ (Advanced Audio Codec with SBR+PS)"), /* long_name */
        ...
        _ff_libaacplus_fmts_64, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof(aacPlusAudioContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        aacPlus_encode_init, /* init */
        0, /* encode_sub */
        aacPlus_encode_frame, /* encode2 */
        0, /* decode */
        aacPlus_encode_close, /* close */
    };
