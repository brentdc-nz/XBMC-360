...
static const enum AVSampleFormat _ff_libvo_amrwbenc_fmts_81[] = { AV_SAMPLE_FMT_S16,
                                                     AV_SAMPLE_FMT_NONE };
AVCodec ff_libvo_amrwbenc_encoder = {
        "libvo_amrwbenc", /* name */
        NULL_IF_CONFIG_SMALL("Android VisualOn AMR-WB "
                                           "(Adaptive Multi-Rate Wide-Band)"), /* long_name */
        ...
        _ff_libvo_amrwbenc_fmts_81, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        &class, /* priv_class */
        0, /* profiles */
        ...
        0, /* defaults */
        0, /* init_static_data */
        amr_wb_encode_init, /* init */
        0, /* encode_sub */
        amr_wb_encode_frame, /* encode2 */
        0, /* decode */
        amr_wb_encode_close, /* close */
    };
