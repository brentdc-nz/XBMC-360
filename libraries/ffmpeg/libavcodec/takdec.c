...
static const enum AVSampleFormat _ff_takdec_fmts_149[] = { AV_SAMPLE_FMT_U8P,
                                                        AV_SAMPLE_FMT_S16P,
                                                        AV_SAMPLE_FMT_S32P,
                                                        AV_SAMPLE_FMT_NONE };
AVCodec ff_tak_decoder = {
        ...
        _ff_takdec_fmts_149, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof(TAKDecContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        tak_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        tak_decode_frame, /* decode */
        tak_decode_close, /* close */
    };
