...
static const AVOption aac_enc_options[] = {
    ...
    { "vbr", "VBR mode (1-5)", offsetof(AACContext, vbr), AV_OPT_TYPE_INT, {0 }, 0, 5, AV_OPT_FLAG_AUDIO_PARAM | AV_OPT_FLAG_ENCODING_PARAM },
    { NULL }
};
...
static const enum AVSampleFormat _ff_libfdk_aacenc_fmts_67[] = { AV_SAMPLE_FMT_S16,
                                                            AV_SAMPLE_FMT_NONE };
AVCodec ff_libfdk_aac_encoder = {
        "libfdk_aac", /* name */
        NULL_IF_CONFIG_SMALL("Fraunhofer FDK AAC"), /* long_name */
        AVMEDIA_TYPE_AUDIO, /* type */
        AV_CODEC_ID_AAC, /* id */
        CODEC_CAP_SMALL_LAST_FRAME | CODEC_CAP_DELAY, /* capabilities */
        0, /* supported_framerates */
        0, /* pix_fmts */
        aac_sample_rates, /* supported_samplerates */
        _ff_libfdk_aacenc_fmts_67, /* sample_fmts */
        aac_channel_layout, /* channel_layouts */
        0, /* max_lowres */
        &aac_enc_class, /* priv_class */
        profiles, /* profiles */
        sizeof(AACContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        aac_encode_defaults, /* defaults */
        0, /* init_static_data */
        aac_encode_init, /* init */
        0, /* encode_sub */
        aac_encode_frame, /* encode2 */
        0, /* decode */
        aac_encode_close, /* close */
    };
