...
static const enum AVPixelFormat _ff_msvideo1enc_fmts_116[] = { AV_PIX_FMT_RGB555, AV_PIX_FMT_NONE };
AVCodec ff_msvideo1_encoder = {
        ...
        _ff_msvideo1enc_fmts_116, /* pix_fmts */
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(Msvideo1EncContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
