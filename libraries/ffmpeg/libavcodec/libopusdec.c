...
static const enum AVSampleFormat _ff_libopusdec_fmts_74[] = { AV_SAMPLE_FMT_FLT,
                                                     AV_SAMPLE_FMT_S16,
                                                     AV_SAMPLE_FMT_NONE };
AVCodec ff_libopus_decoder = {
        ...
        _ff_libopusdec_fmts_74, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof(struct libopus_context), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        libopus_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        libopus_decode, /* decode */
        libopus_decode_close, /* close */
        libopus_flush, /* flush */
    };
