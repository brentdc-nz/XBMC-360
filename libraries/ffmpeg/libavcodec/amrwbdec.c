...
static const enum AVSampleFormat _ff_amrwbdec_fmts_17[] = { AV_SAMPLE_FMT_FLT,
                                                     AV_SAMPLE_FMT_NONE };
AVCodec ff_amrwb_decoder = {
        ...
        _ff_amrwbdec_fmts_17, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        ...
        0, /* defaults */
        0, /* init_static_data */
        amrwb_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        amrwb_decode_frame, /* decode */
    };
