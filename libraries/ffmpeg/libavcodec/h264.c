...
AVCodec ff_h264_decoder = {
        ...
        /*CODEC_CAP_DRAW_HORIZ_BAND |*/ CODEC_CAP_DR1 |
                             ...
                             CODEC_CAP_FRAME_THREADS, /* capabilities */
        ...
        sizeof(H264Context), /* priv_data_size */
        0, /* next */
        ONLY_IF_THREADS_ENABLED(decode_init_thread_copy), /* init_thread_copy */
        ONLY_IF_THREADS_ENABLED(decode_update_thread_context), /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        ff_h264_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        decode_frame, /* decode */
        h264_decode_end, /* close */
        flush_dpb, /* flush */
    };

#if CONFIG_H264_VDPAU_DECODER
static const enum AVPixelFormat _ff_h264_fmts_56[] = { AV_PIX_FMT_VDPAU_H264,
                                                   AV_PIX_FMT_NONE };
AVCodec ff_h264_vdpau_decoder = {
        "h264_vdpau", /* name */
        NULL_IF_CONFIG_SMALL("H.264 / AVC / MPEG-4 AVC / MPEG-4 part 10 (VDPAU acceleration)"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_H264, /* id */
        CODEC_CAP_DR1 | CODEC_CAP_DELAY | CODEC_CAP_HWACCEL_VDPAU, /* capabilities */
        0, /* supported_framerates */
        _ff_h264_fmts_56, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        &h264_vdpau_class, /* priv_class */
        NULL_IF_CONFIG_SMALL(profiles), /* profiles */
        sizeof(H264Context), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
