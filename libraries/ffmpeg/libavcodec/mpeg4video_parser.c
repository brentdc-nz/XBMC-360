                                  ...
                                  const uint8_t *buf, int buf_size)
{
    ...
    if((s1->flags & PARSER_FLAG_USE_CODEC_TS) && s->avctx->time_base.den>0 && ret>=0){
        ...
        s1->pts = av_rescale_q(s->time, av_make_q(1, s->avctx->time_base.den), av_make_q(1, 1200000));
    }
...
AVCodecParser ff_mpeg4video_parser = {
        { AV_CODEC_ID_MPEG4 }, /* codec_ids */
        sizeof(struct Mp4vParseContext), /* priv_data_size */
        mpeg4video_parse_init, /* parser_init */
        mpeg4video_parse, /* parser_parse */
