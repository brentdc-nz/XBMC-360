...
static const enum AVSampleFormat _ff_wmadec_fmts_164[] = { AV_SAMPLE_FMT_FLTP,
                                                      AV_SAMPLE_FMT_NONE };
AVCodec ff_wmav1_decoder = {
        ...
        _ff_wmadec_fmts_164, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof(WMACodecContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        wma_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        wma_decode_superframe, /* decode */
        ff_wma_end, /* close */
        flush, /* flush */
    };
#endif
#if CONFIG_WMAV2_DECODER
static const enum AVSampleFormat _ff_wmadec_fmts_165[] = { AV_SAMPLE_FMT_FLTP,
                                                      AV_SAMPLE_FMT_NONE };
AVCodec ff_wmav2_decoder = {
        ...
        0, /* pix_fmts */
        0, /* supported_samplerates */
        _ff_wmadec_fmts_165, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
