...
static const enum AVPixelFormat _ff_asvenc_fmts_21[] = { AV_PIX_FMT_YUV420P,
                                                    AV_PIX_FMT_NONE };
AVCodec ff_asv1_encoder = {
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(ASV1Context), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
...
static const enum AVPixelFormat _ff_asvenc_fmts_22[] = { AV_PIX_FMT_YUV420P,
                                                    AV_PIX_FMT_NONE };
