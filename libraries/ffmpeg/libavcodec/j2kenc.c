...
static const enum AVPixelFormat _ff_j2kenc_fmts_61[] = { AV_PIX_FMT_RGB24, AV_PIX_FMT_YUV444P, AV_PIX_FMT_GRAY8,
/*      AV_PIX_FMT_YUV420P,
...
AVCodec ff_jpeg2000_encoder = {
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(J2kEncoderContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
