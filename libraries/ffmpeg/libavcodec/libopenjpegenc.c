...
static const AVClass class = {
        "libopenjpeg", /* class_name */
        av_default_item_name, /* item_name */
        options, /* option */
        LIBAVUTIL_VERSION_INT, /* version */
    };

static const enum AVPixelFormat _ff_libopenjpegenc_fmts_73[] = { AV_PIX_FMT_RGB24, AV_PIX_FMT_RGBA, AV_PIX_FMT_RGB48, AV_PIX_FMT_RGBA64,
        AV_PIX_FMT_GBR24P,
...
AVCodec ff_libopenjpeg_encoder = {
        "libopenjpeg", /* name */
        NULL_IF_CONFIG_SMALL("OpenJPEG JPEG 2000"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_JPEG2000, /* id */
        0, /* capabilities */
        0, /* supported_framerates */
        _ff_libopenjpegenc_fmts_73, /* pix_fmts */
        ...
        &class, /* priv_class */
        0, /* profiles */
        sizeof(LibOpenJPEGContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        libopenjpeg_encode_init, /* init */
        0, /* encode_sub */
        libopenjpeg_encode_frame, /* encode2 */
        0, /* decode */
        libopenjpeg_encode_close, /* close */
    };
