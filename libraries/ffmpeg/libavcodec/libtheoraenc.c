...
static const enum AVPixelFormat _ff_libtheoraenc_fmts_78[] = { AV_PIX_FMT_YUV420P, AV_PIX_FMT_YUV422P, AV_PIX_FMT_YUV444P, AV_PIX_FMT_NONE };
AVCodec ff_libtheora_encoder = {
        "libtheora", /* name */
        NULL_IF_CONFIG_SMALL("libtheora Theora"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_THEORA, /* id */
        CODEC_CAP_DELAY, /* capabilities */
        0, /* supported_framerates */
        _ff_libtheoraenc_fmts_78, /* pix_fmts */
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(TheoraContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
