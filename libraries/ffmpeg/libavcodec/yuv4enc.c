...
static const enum AVPixelFormat _ff_yuv4enc_fmts_176[] = { AV_PIX_FMT_YUV420P, AV_PIX_FMT_NONE };
AVCodec ff_yuv4_encoder = {
        ...
        0, /* defaults */
        0, /* init_static_data */
        yuv4_encode_init, /* init */
        0, /* encode_sub */
        yuv4_encode_frame, /* encode2 */
        0, /* decode */
        yuv4_encode_close, /* close */
    };
