...
static const enum AVPixelFormat _ff_proresenc_anatoliy_fmts_129[] = { AV_PIX_FMT_YUV422P10, AV_PIX_FMT_NONE };
AVCodec ff_prores_anatoliy_encoder = {
        "prores_anatoliy", /* name */
        NULL_IF_CONFIG_SMALL("Apple ProRes"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_PRORES, /* id */
        CODEC_CAP_FRAME_THREADS | CODEC_CAP_INTRA_ONLY, /* capabilities */
        0, /* supported_framerates */
        _ff_proresenc_anatoliy_fmts_129, /* pix_fmts */
        ...
        0, /* priv_class */
        profiles, /* profiles */
        sizeof(ProresContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        prores_encode_init, /* init */
        0, /* encode_sub */
        prores_encode_frame, /* encode2 */
        0, /* decode */
        prores_encode_close, /* close */
    };

static const enum AVPixelFormat _ff_proresenc_anatoliy_fmts_130[] = { AV_PIX_FMT_YUV422P10, AV_PIX_FMT_NONE };
AVCodec ff_prores_encoder = {
        ...
        CODEC_CAP_FRAME_THREADS | CODEC_CAP_INTRA_ONLY, /* capabilities */
        0, /* supported_framerates */
        _ff_proresenc_anatoliy_fmts_130, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
