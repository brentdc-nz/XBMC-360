...
static const enum AVPixelFormat _ff_ljpegenc_fmts_89[] = { AV_PIX_FMT_BGR24, AV_PIX_FMT_BGRA, AV_PIX_FMT_BGR0,
...
AVCodec ff_ljpeg_encoder = {
        ...
        0, /* encode_sub */
        encode_picture_lossless, /* encode2 */
        0, /* decode */
