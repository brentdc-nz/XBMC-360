...
static const enum AVSampleFormat _ff_imc_fmts_59[] = { AV_SAMPLE_FMT_FLTP,
                                                      AV_SAMPLE_FMT_NONE };
AVCodec ff_imc_decoder = {
        ...
        _ff_imc_fmts_59, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof(IMCContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        imc_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        imc_decode_frame, /* decode */
        imc_decode_close, /* close */
        flush, /* flush */
    };
#endif
#if CONFIG_IAC_DECODER
static const enum AVSampleFormat _ff_imc_fmts_60[] = { AV_SAMPLE_FMT_FLTP,
                                                      AV_SAMPLE_FMT_NONE };
