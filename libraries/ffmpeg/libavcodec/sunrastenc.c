...
static const enum AVPixelFormat _ff_sunrastenc_fmts_145[] = { AV_PIX_FMT_BGR24,
                                                  AV_PIX_FMT_PAL8,
                                                  AV_PIX_FMT_GRAY8,
...
AVCodec ff_sunrast_encoder = {
        ...
        _ff_sunrastenc_fmts_145, /* pix_fmts */
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(SUNRASTContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        sunrast_defaults, /* defaults */
        0, /* init_static_data */
        sunrast_encode_init, /* init */
        0, /* encode_sub */
        sunrast_encode_frame, /* encode2 */
    };
