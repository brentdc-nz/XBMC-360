...
static const enum AVPixelFormat _ff_libxavs_fmts_86[] = { AV_PIX_FMT_YUV420P, AV_PIX_FMT_NONE };
AVCodec ff_libxavs_encoder = {
        "libxavs", /* name */
        NULL_IF_CONFIG_SMALL("libxavs Chinese AVS (Audio Video Standard)"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_CAVS, /* id */
        CODEC_CAP_DELAY | CODEC_CAP_AUTO_THREADS, /* capabilities */
        0, /* supported_framerates */
        _ff_libxavs_fmts_86, /* pix_fmts */
        ...
        &class, /* priv_class */
        0, /* profiles */
        sizeof(XavsContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        xavs_defaults, /* defaults */
        0, /* init_static_data */
        XAVS_init, /* init */
        0, /* encode_sub */
        XAVS_frame, /* encode2 */
