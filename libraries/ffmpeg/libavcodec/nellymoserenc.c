...
static const enum AVSampleFormat _ff_nellymoserenc_fmts_118[] = { AV_SAMPLE_FMT_FLT,
                                                     AV_SAMPLE_FMT_NONE };
AVCodec ff_nellymoser_encoder = {
        ...
        _ff_nellymoserenc_fmts_118, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof(NellyMoserEncodeContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
