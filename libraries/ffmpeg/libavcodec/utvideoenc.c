...
static const enum AVPixelFormat _ff_utvideoenc_fmts_153[] = { AV_PIX_FMT_RGB24, AV_PIX_FMT_RGBA, AV_PIX_FMT_YUV422P,
...
AVCodec ff_utvideo_encoder = {
        ...
        _ff_utvideoenc_fmts_153, /* pix_fmts */
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(UtvideoContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        utvideo_encode_init, /* init */
        0, /* encode_sub */
        utvideo_encode_frame, /* encode2 */
        0, /* decode */
        utvideo_encode_close, /* close */
    };
