...
static const enum AVPixelFormat _ff_dnxhdenc_fmts_39[] = { AV_PIX_FMT_YUV422P,
...
AVCodec ff_dnxhd_encoder = {
        ...
        &class, /* priv_class */
        0, /* profiles */
        sizeof(DNXHDEncContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        dnxhd_defaults, /* defaults */
        0, /* init_static_data */
        dnxhd_encode_init, /* init */
        0, /* encode_sub */
        dnxhd_encode_picture, /* encode2 */
        0, /* decode */
        dnxhd_encode_end, /* close */
    };
