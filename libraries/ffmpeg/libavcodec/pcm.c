...
AVCodec ff_ ## name ## _encoder = {                    \
    ...
    pcm_encode_close,                           \
    NULL,                                       \
    .sample_fmts = (const enum SampleFormat[]){sample_fmt_,AV_SAMPLE_FMT_NONE}, \
    .long_name = NULL_IF_CONFIG_SMALL(long_name_), \
};
#else
#define PCM_ENCODER(id,sample_fmt_,name,long_name_) \
const enum SampleFormat name ## __enc_samples[] = {sample_fmt_,AV_SAMPLE_FMT_NONE}; \
...
#else
#define PCM_DECODER(id,sample_fmt_,name,long_name_)         \
const enum SampleFormat name ## __dec_samples[] = {sample_fmt_,AV_SAMPLE_FMT_NONE}; \
AVCodec ff_ ## name ## _decoder = {                    \
    #name,                                      \
    AVMEDIA_TYPE_AUDIO,                         \
    id,                                         \
