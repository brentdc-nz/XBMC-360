...
static const enum AVSampleFormat _ff_pcm_ ## name_ ## _enc_fmts[] = {      \
...
AVCodec ff_ ## name_ ## _encoder = {                                        \
    ...
    /* sample_fmts */            _ff_pcm_ ## name_ ## _enc_fmts,            \
    /* channel_layouts */        0,                                         \
    /* max_lowres */             0,                                         \
    /* priv_class */             0,                                         \
    /* profiles */               0,                                         \
...
static const enum AVSampleFormat _ff_pcm_ ## name_ ## _dec_fmts[] = {      \
    sample_fmt_, AV_SAMPLE_FMT_NONE };                                      \
AVCodec ff_ ## name_ ## _decoder = {                                        \
    ...
    /* pix_fmts */               0,                                         \
    /* supported_samplerates */  0,                                         \
    /* sample_fmts */            _ff_pcm_ ## name_ ## _dec_fmts,            \
    /* channel_layouts */        0,                                         \
    /* max_lowres */             0,                                         \
    /* priv_class */             0,                                         \
    /* profiles */               0,                                         \
