...
static const enum AVSampleFormat _ff_mpc7_fmts_94[] = { AV_SAMPLE_FMT_S16P,
                                                      AV_SAMPLE_FMT_NONE };
AVCodec ff_mpc7_decoder = {
        ...
        _ff_mpc7_fmts_94, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof(MPCContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        mpc7_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        mpc7_decode_frame, /* decode */
        mpc7_decode_close, /* close */
