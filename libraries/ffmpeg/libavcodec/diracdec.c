...
AVCodec ff_dirac_decoder = {
        "dirac", /* name */
        NULL_IF_CONFIG_SMALL("BBC Dirac VC-2"), /* long_name */
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(DiracContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        dirac_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        dirac_decode_frame, /* decode */
        dirac_decode_end, /* close */
        dirac_decode_flush, /* flush */
    };
