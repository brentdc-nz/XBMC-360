...
static const enum AVPixelFormat _ff_v308enc_fmts_155[] = { AV_PIX_FMT_YUV444P, AV_PIX_FMT_NONE };
AVCodec ff_v308_encoder = {
        ...
        0, /* defaults */
        0, /* init_static_data */
        v308_encode_init, /* init */
        0, /* encode_sub */
        v308_encode_frame, /* encode2 */
        0, /* decode */
        v308_encode_close, /* close */
    };
