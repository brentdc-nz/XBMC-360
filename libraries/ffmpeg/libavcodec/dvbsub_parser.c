...
AVCodecParser ff_dvbsub_parser = {
        { AV_CODEC_ID_DVB_SUBTITLE }, /* codec_ids */
        sizeof(DVBSubParseContext), /* priv_data_size */
        dvbsub_parse_init, /* parser_init */
        dvbsub_parse, /* parser_parse */
        dvbsub_parse_close, /* parser_close */
    };
