...
static const enum AVPixelFormat _ff_flashsvenc_fmts_49[] = { AV_PIX_FMT_BGR24, AV_PIX_FMT_NONE };
AVCodec ff_flashsv_encoder = {
        "flashsv", /* name */
        NULL_IF_CONFIG_SMALL("Flash Screen Video"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_FLASHSV, /* id */
        0, /* capabilities */
        0, /* supported_framerates */
        _ff_flashsvenc_fmts_49, /* pix_fmts */
        ...
        0, /* defaults */
        0, /* init_static_data */
        flashsv_encode_init, /* init */
        0, /* encode_sub */
        flashsv_encode_frame, /* encode2 */
        0, /* decode */
        flashsv_encode_end, /* close */
    };
