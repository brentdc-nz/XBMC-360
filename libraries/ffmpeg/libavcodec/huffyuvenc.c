...
static const enum AVPixelFormat _ff_huffyuvenc_fmts_57[] = { AV_PIX_FMT_YUV422P, AV_PIX_FMT_RGB24, AV_PIX_FMT_RGB32, AV_PIX_FMT_NONE };
AVCodec ff_huffyuv_encoder = {
        "huffyuv", /* name */
        NULL_IF_CONFIG_SMALL("Huffyuv / HuffYUV"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_HUFFYUV, /* id */
        0, /* capabilities */
        0, /* supported_framerates */
        _ff_huffyuvenc_fmts_57, /* pix_fmts */
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(HYuvContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
...
static const enum AVPixelFormat _ff_huffyuvenc_fmts_58[] = { AV_PIX_FMT_YUV420P, AV_PIX_FMT_YUV422P, AV_PIX_FMT_RGB24, AV_PIX_FMT_RGB32, AV_PIX_FMT_NONE };
AVCodec ff_ffvhuff_encoder = {
        ...
        0, /* capabilities */
        0, /* supported_framerates */
        _ff_huffyuvenc_fmts_58, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
