...
static const enum AVSampleFormat _ff_8svx_fmts_1[] = { AV_SAMPLE_FMT_U8P,
                                                    AV_SAMPLE_FMT_NONE };
AVCodec ff_eightsvx_fib_decoder = {
        ...
        _ff_8svx_fmts_1, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof (EightSvxContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        eightsvx_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        eightsvx_decode_frame, /* decode */
        eightsvx_decode_close, /* close */
    };
#endif
#if CONFIG_EIGHTSVX_EXP_DECODER
static const enum AVSampleFormat _ff_8svx_fmts_2[] = { AV_SAMPLE_FMT_U8P,
                                                    AV_SAMPLE_FMT_NONE };
