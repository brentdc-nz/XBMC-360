...
static const enum AVPixelFormat _ff_svq1dec_fmts_146[] = { AV_PIX_FMT_YUV410P,
                                                     AV_PIX_FMT_NONE };
AVCodec ff_svq1_decoder = {
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(SVQ1Context), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        svq1_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        svq1_decode_frame, /* decode */
        svq1_decode_end, /* close */
        svq1_flush, /* flush */
    };
