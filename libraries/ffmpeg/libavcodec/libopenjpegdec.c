...
AVCodec ff_libopenjpeg_decoder = {
        ...
        CODEC_CAP_DR1 | CODEC_CAP_FRAME_THREADS, /* capabilities */
        ...
        0, /* next */
        ONLY_IF_THREADS_ENABLED(libopenjpeg_decode_init_thread_copy), /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        libopenjpeg_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        libopenjpeg_decode_frame, /* decode */
        libopenjpeg_decode_close, /* close */
    };
