...
static const enum PixelFormat _ff_xfaceenc_fmts_173[] = { AV_PIX_FMT_MONOWHITE, AV_PIX_FMT_NONE };
AVCodec ff_xface_encoder = {
        ...
        _ff_xfaceenc_fmts_173, /* pix_fmts */
        ...
        0, /* defaults */
        0, /* init_static_data */
        xface_encode_init, /* init */
        0, /* encode_sub */
        xface_encode_frame, /* encode2 */
        0, /* decode */
        xface_encode_close, /* close */
    };
