...
static const enum AVPixelFormat _ff_y41penc_fmts_175[] = { AV_PIX_FMT_YUV411P,
                                                 AV_PIX_FMT_NONE };
AVCodec ff_y41p_encoder = {
        ...
        0, /* defaults */
        0, /* init_static_data */
        y41p_encode_init, /* init */
        0, /* encode_sub */
        y41p_encode_frame, /* encode2 */
        0, /* decode */
        y41p_encode_close, /* close */
    };
