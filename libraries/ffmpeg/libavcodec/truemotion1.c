...
static int truemotion1_decode_header(TrueMotion1Context *s)
{
    ...
    if (s->w != s->avctx->width || s->h != s->avctx->height ||
        ...
        s->avctx->sample_aspect_ratio = av_make_q(1 << width_shift, 1);
...
AVCodec ff_truemotion1_decoder = {
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(TrueMotion1Context), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        truemotion1_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        truemotion1_decode_frame, /* decode */
        truemotion1_decode_end, /* close */
    };
