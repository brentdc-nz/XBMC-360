...
static const AVOption options[] = {
    ...
    { "vad",               "Voice Activity Detection",                  OFFSET(vad),               AV_OPT_TYPE_INT, {0 }, 0,   1, AE },
    { "dtx",               "Discontinuous Transmission",                OFFSET(dtx),               AV_OPT_TYPE_INT, {0 }, 0,   1, AE },
    { NULL },
};
...
static const enum AVSampleFormat _ff_libspeexenc_fmts_77[] = { AV_SAMPLE_FMT_S16,
                                                     AV_SAMPLE_FMT_NONE };
AVCodec ff_libspeex_encoder = {
        "libspeex", /* name */
        NULL_IF_CONFIG_SMALL("libspeex Speex"), /* long_name */
        AVMEDIA_TYPE_AUDIO, /* type */
        AV_CODEC_ID_SPEEX, /* id */
        CODEC_CAP_DELAY, /* capabilities */
        0, /* supported_framerates */
        0, /* pix_fmts */
        static const int _cla_libspeexenc_1[] = {8000, 16000, 32000, 0};
        _cla_libspeexenc_1, /* supported_samplerates */
        _ff_libspeexenc_fmts_77, /* sample_fmts */
        static const uint64_t _cla_libspeexenc_2[] = {AV_CH_LAYOUT_MONO,
                                           AV_CH_LAYOUT_STEREO,
                                           0};
        _cla_libspeexenc_2, /* channel_layouts */
        0, /* max_lowres */
        &class, /* priv_class */
        0, /* profiles */
        sizeof(LibSpeexEncContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
