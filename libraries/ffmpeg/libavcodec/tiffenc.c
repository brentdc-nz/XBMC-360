...
static const AVClass tiffenc_class = {
        "TIFF encoder", /* class_name */
        av_default_item_name, /* item_name */
        options, /* option */
        LIBAVUTIL_VERSION_INT, /* version */
    };

static const enum AVPixelFormat _ff_tiffenc_fmts_151[] = { AV_PIX_FMT_RGB24, AV_PIX_FMT_PAL8, AV_PIX_FMT_GRAY8,
...
AVCodec ff_tiff_encoder = {
        ...
        _ff_tiffenc_fmts_151, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        &tiffenc_class, /* priv_class */
        0, /* profiles */
        sizeof(TiffEncoderContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
