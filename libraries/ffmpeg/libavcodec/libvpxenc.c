...
#endif
{"speed", "", offsetof(VP8Context, cpu_used), AV_OPT_TYPE_INT, {3}, -16, 16, VE},
{"quality", "", offsetof(VP8Context, deadline), AV_OPT_TYPE_INT, {VPX_DL_GOOD_QUALITY}, INT_MIN, INT_MAX, VE, "quality"},
{"vp8flags", "", offsetof(VP8Context, flags), FF_OPT_TYPE_FLAGS, {0}, 0, UINT_MAX, VE, "flags"},
{"error_resilient", "enable error resilience", 0, FF_OPT_TYPE_CONST, {0}, INT_MIN, INT_MAX, VE, "flags"},
{"altref", "enable use of alternate reference frames (VP8/2-pass only)", 0, FF_OPT_TYPE_CONST, {0}, INT_MIN, INT_MAX, VE, "flags"},
{"arnr_max_frames", "altref noise reduction max frame count", offsetof(VP8Context, arnr_max_frames), AV_OPT_TYPE_INT, {0}, 0, 15, VE},
{"arnr_strength", "altref noise reduction filter strength", offsetof(VP8Context, arnr_strength), AV_OPT_TYPE_INT, {3}, 0, 6, VE},
{"arnr_type", "altref noise reduction filter type", offsetof(VP8Context, arnr_type), AV_OPT_TYPE_INT, {3}, 1, 3, VE},
{"rc_lookahead", "Number of frames to look ahead for alternate reference frame selection", offsetof(VP8Context, lag_in_frames), AV_OPT_TYPE_INT, {25}, 0, 25, VE},
    { "crf",              "Select the quality for constant quality mode", offsetof(VP8Context, crf), AV_OPT_TYPE_INT, {0}, 0, 63, VE },
    { NULL }
};
...
static const AVClass class_vp8 = {
        "libvpx encoder", /* class_name */
        av_default_item_name, /* item_name */
        options, /* option */
        LIBAVUTIL_VERSION_INT, /* version */
    };

static const enum AVPixelFormat _ff_libvpxenc_fmts_84[] = { AV_PIX_FMT_YUV420P, AV_PIX_FMT_NONE };
AVCodec ff_libvpx_vp8_encoder = {
        "libvpx", /* name */
        NULL_IF_CONFIG_SMALL("libvpx VP8"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_VP8, /* id */
        CODEC_CAP_DELAY | CODEC_CAP_AUTO_THREADS, /* capabilities */
        0, /* supported_framerates */
        _ff_libvpxenc_fmts_84, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        &class_vp8, /* priv_class */
        0, /* profiles */
...
static const enum AVPixelFormat _ff_libvpxenc_fmts_85[] = { AV_PIX_FMT_YUV420P, AV_PIX_FMT_NONE };
AVCodec ff_libvpx_vp9_encoder = {
        "libvpx-vp9", /* name */
        NULL_IF_CONFIG_SMALL("libvpx VP9"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_VP9, /* id */
        CODEC_CAP_DELAY | CODEC_CAP_AUTO_THREADS | CODEC_CAP_EXPERIMENTAL, /* capabilities */
        0, /* supported_framerates */
        _ff_libvpxenc_fmts_85, /* pix_fmts */
        0, /* supported_samplerates */
        0, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        &class_vp9, /* priv_class */
        0, /* profiles */
        sizeof(VP8Context), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
