...
static const enum AVSampleFormat _ff_aacenc_fmts_8[] = { AV_SAMPLE_FMT_FLTP,
                                                     AV_SAMPLE_FMT_NONE };
AVCodec ff_aac_encoder = {
        ...
        CODEC_CAP_SMALL_LAST_FRAME | CODEC_CAP_DELAY |
                      CODEC_CAP_EXPERIMENTAL, /* capabilities */
        0, /* supported_framerates */
        0, /* pix_fmts */
        mpeg4audio_sample_rates, /* supported_samplerates */
        _ff_aacenc_fmts_8, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        &aacenc_class, /* priv_class */
        0, /* profiles */
        sizeof(AACEncContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
