...
static const enum AVPixelFormat _ff_mjpegenc_fmts_92[] = { AV_PIX_FMT_YUVJ420P, AV_PIX_FMT_YUVJ422P, AV_PIX_FMT_YUVJ444P, AV_PIX_FMT_NONE };
AVCodec ff_mjpeg_encoder = {
        "mjpeg", /* name */
        NULL_IF_CONFIG_SMALL("MJPEG (Motion JPEG)"), /* long_name */
        AVMEDIA_TYPE_VIDEO, /* type */
        AV_CODEC_ID_MJPEG, /* id */
        CODEC_CAP_SLICE_THREADS | CODEC_CAP_FRAME_THREADS | CODEC_CAP_INTRA_ONLY, /* capabilities */
        0, /* supported_framerates */
        _ff_mjpegenc_fmts_92, /* pix_fmts */
...
static const enum AVPixelFormat _ff_mjpegenc_fmts_93[] = { AV_PIX_FMT_YUVJ420P, AV_PIX_FMT_YUVJ422P, AV_PIX_FMT_NONE };
