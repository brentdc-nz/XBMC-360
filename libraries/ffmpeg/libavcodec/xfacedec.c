...
static const enum AVPixelFormat _ff_xfacedec_fmts_172[] = { AV_PIX_FMT_MONOWHITE, AV_PIX_FMT_NONE };
AVCodec ff_xface_decoder = {
        ...
        _ff_xfacedec_fmts_172, /* pix_fmts */
        ...
        0, /* priv_class */
        0, /* profiles */
        sizeof(XFaceContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        xface_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        xface_decode_frame, /* decode */
        xface_decode_close, /* close */
    };
