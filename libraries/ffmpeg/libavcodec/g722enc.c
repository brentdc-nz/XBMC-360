...
static const enum AVSampleFormat _ff_g722enc_fmts_51[] = { AV_SAMPLE_FMT_S16,
                                                     AV_SAMPLE_FMT_NONE };
AVCodec ff_adpcm_g722_encoder = {
        ...
        _ff_g722enc_fmts_51, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof(G722Context), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        g722_encode_init, /* init */
        0, /* encode_sub */
        g722_encode_frame, /* encode2 */
        0, /* decode */
        g722_encode_close, /* close */
    };
