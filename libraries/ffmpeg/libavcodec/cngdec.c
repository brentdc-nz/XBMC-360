...
static const enum AVSampleFormat _ff_cngdec_fmts_28[] = { AV_SAMPLE_FMT_S16,
                                                     AV_SAMPLE_FMT_NONE };
AVCodec ff_comfortnoise_decoder = {
        "comfortnoise", /* name */
        NULL_IF_CONFIG_SMALL("RFC 3389 comfort noise generator"), /* long_name */
        AVMEDIA_TYPE_AUDIO, /* type */
        AV_CODEC_ID_COMFORT_NOISE, /* id */
        CODEC_CAP_DELAY | CODEC_CAP_DR1, /* capabilities */
        0, /* supported_framerates */
        0, /* pix_fmts */
        0, /* supported_samplerates */
        _ff_cngdec_fmts_28, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof(CNGContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        cng_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        cng_decode_frame, /* decode */
        cng_decode_close, /* close */
        cng_decode_flush, /* flush */
    };
