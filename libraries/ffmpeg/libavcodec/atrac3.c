...
static const enum AVSampleFormat _ff_atrac3_fmts_24[] = { AV_SAMPLE_FMT_FLTP,
                                                        AV_SAMPLE_FMT_NONE };
AVCodec ff_atrac3_decoder = {
        ...
        _ff_atrac3_fmts_24, /* sample_fmts */
        0, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof(ATRAC3Context), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        atrac3_decode_init, /* init */
        0, /* encode_sub */
        0, /* encode2 */
        atrac3_decode_frame, /* decode */
        atrac3_decode_close, /* close */
    };
