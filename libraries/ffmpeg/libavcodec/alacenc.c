...
static const enum AVSampleFormat _ff_alacenc_fmts_15[] = { AV_SAMPLE_FMT_S32P,
                                                     AV_SAMPLE_FMT_S16P,
                                                     AV_SAMPLE_FMT_NONE };
AVCodec ff_alac_encoder = {
        ...
        _ff_alacenc_fmts_15, /* sample_fmts */
        ff_alac_channel_layouts, /* channel_layouts */
        0, /* max_lowres */
        0, /* priv_class */
        0, /* profiles */
        sizeof(AlacEncodeContext), /* priv_data_size */
        0, /* next */
        0, /* init_thread_copy */
        0, /* update_thread_context */
        0, /* defaults */
        0, /* init_static_data */
        alac_encode_init, /* init */
        0, /* encode_sub */
        alac_encode_frame, /* encode2 */
        0, /* decode */
        alac_encode_close, /* close */
    };
