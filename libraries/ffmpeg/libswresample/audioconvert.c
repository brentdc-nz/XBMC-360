...
#ifdef MSC_STRUCTS
/*
 * MSVC C89: no designated array initializers [idx]=val.
 * Positional init: 10 entries per row (AV_SAMPLE_FMT_NB=10),
 * first 5 are packed formats, last 5 are NULL (planar).
 * Rows 5-9 (planar input) are all NULL.
 */
...
static conv_func_type * const fmt_pair_to_conv_functions[AV_SAMPLE_FMT_NB*AV_SAMPLE_FMT_NB] = {
    /* in=U8  */ CONV_FUNC_NAME(AV_SAMPLE_FMT_U8,AV_SAMPLE_FMT_U8), CONV_FUNC_NAME(AV_SAMPLE_FMT_S16,AV_SAMPLE_FMT_U8), CONV_FUNC_NAME(AV_SAMPLE_FMT_S32,AV_SAMPLE_FMT_U8), CONV_FUNC_NAME(AV_SAMPLE_FMT_FLT,AV_SAMPLE_FMT_U8), CONV_FUNC_NAME(AV_SAMPLE_FMT_DBL,AV_SAMPLE_FMT_U8), NULL5,
    /* in=S16 */ CONV_FUNC_NAME(AV_SAMPLE_FMT_U8,AV_SAMPLE_FMT_S16), CONV_FUNC_NAME(AV_SAMPLE_FMT_S16,AV_SAMPLE_FMT_S16), CONV_FUNC_NAME(AV_SAMPLE_FMT_S32,AV_SAMPLE_FMT_S16), CONV_FUNC_NAME(AV_SAMPLE_FMT_FLT,AV_SAMPLE_FMT_S16), CONV_FUNC_NAME(AV_SAMPLE_FMT_DBL,AV_SAMPLE_FMT_S16), NULL5,
    /* in=S32 */ CONV_FUNC_NAME(AV_SAMPLE_FMT_U8,AV_SAMPLE_FMT_S32), CONV_FUNC_NAME(AV_SAMPLE_FMT_S16,AV_SAMPLE_FMT_S32), CONV_FUNC_NAME(AV_SAMPLE_FMT_S32,AV_SAMPLE_FMT_S32), CONV_FUNC_NAME(AV_SAMPLE_FMT_FLT,AV_SAMPLE_FMT_S32), CONV_FUNC_NAME(AV_SAMPLE_FMT_DBL,AV_SAMPLE_FMT_S32), NULL5,
    /* in=FLT */ CONV_FUNC_NAME(AV_SAMPLE_FMT_U8,AV_SAMPLE_FMT_FLT), CONV_FUNC_NAME(AV_SAMPLE_FMT_S16,AV_SAMPLE_FMT_FLT), CONV_FUNC_NAME(AV_SAMPLE_FMT_S32,AV_SAMPLE_FMT_FLT), CONV_FUNC_NAME(AV_SAMPLE_FMT_FLT,AV_SAMPLE_FMT_FLT), CONV_FUNC_NAME(AV_SAMPLE_FMT_DBL,AV_SAMPLE_FMT_FLT), NULL5,
    /* in=DBL */ CONV_FUNC_NAME(AV_SAMPLE_FMT_U8,AV_SAMPLE_FMT_DBL), CONV_FUNC_NAME(AV_SAMPLE_FMT_S16,AV_SAMPLE_FMT_DBL), CONV_FUNC_NAME(AV_SAMPLE_FMT_S32,AV_SAMPLE_FMT_DBL), CONV_FUNC_NAME(AV_SAMPLE_FMT_FLT,AV_SAMPLE_FMT_DBL), CONV_FUNC_NAME(AV_SAMPLE_FMT_DBL,AV_SAMPLE_FMT_DBL), NULL5,
    /* in=U8P..DBLP (planar inputs): all NULL */
    NULL5, NULL5, NULL5, NULL5, NULL5, NULL5, NULL5, NULL5, NULL5, NULL5,
};
#undef NULL5
#else
