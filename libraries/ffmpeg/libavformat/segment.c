...
static const AVOption options[] = {
    { "reference_stream",  "set reference stream", OFFSET(reference_stream_specifier), AV_OPT_TYPE_STRING, { 0 }, CHAR_MIN, CHAR_MAX, E },
    { "segment_format",    "set container format used for the segments", OFFSET(format),  AV_OPT_TYPE_STRING, { 0, 0, NULL },  0, 0,       E },
    { "segment_list",      "set the segment list filename",              OFFSET(list),    AV_OPT_TYPE_STRING, { 0, 0, NULL },  0, 0,       E },
    ...
    { "segment_time",      "set segment duration",                       OFFSET(time_str),AV_OPT_TYPE_STRING, { 0, 0, NULL },  0, 0,       E },
    { "segment_time_delta","set approximation value used for the segment times", OFFSET(time_delta_str), AV_OPT_TYPE_STRING, { 0 }, 0, 0, E },
    { "segment_times",     "set segment split time points",              OFFSET(times_str),AV_OPT_TYPE_STRING,{ 0, 0, NULL },  0, 0,       E },
    { "segment_frames",    "set segment split frame numbers",            OFFSET(frames_str),AV_OPT_TYPE_STRING,{ 0, 0, NULL },  0, 0,       E },
...
AVOutputFormat ff_segment_muxer = {
    "segment", /* name */
    NULL_IF_CONFIG_SMALL("segment"), /* long_name */
    0, /* mime_type */
    0, /* extensions */
    0, /* audio_codec */
    0, /* video_codec */
    ...
    0, /* codec_tag */
    &seg_class, /* priv_class */
    0, /* next */
    sizeof(SegmentContext), /* priv_data_size */
    seg_write_header, /* write_header */
    seg_write_packet, /* write_packet */
    seg_write_trailer, /* write_trailer */
};

static const AVClass sseg_class = {
    "stream_segment muxer", /* class_name */
    av_default_item_name, /* item_name */
    options, /* option */
    LIBAVUTIL_VERSION_INT, /* version */
};
...
AVOutputFormat ff_stream_segment_muxer = {
    "stream_segment,ssegment", /* name */
    NULL_IF_CONFIG_SMALL("streaming segment muxer"), /* long_name */
    0, /* mime_type */
    0, /* extensions */
    0, /* audio_codec */
    0, /* video_codec */
