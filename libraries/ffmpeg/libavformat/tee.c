...
AVOutputFormat ff_tee_muxer = {
    "tee", /* name */
    NULL_IF_CONFIG_SMALL("Multiple muxer tee"), /* long_name */
    0, /* mime_type */
    0, /* extensions */
    0, /* audio_codec */
    0, /* video_codec */
    ...
    AVFMT_NOFILE, /* flags */
    0, /* codec_tag */
    &tee_muxer_class, /* priv_class */
    0, /* next */
    sizeof(TeeContext), /* priv_data_size */
    tee_write_header, /* write_header */
    tee_write_packet, /* write_packet */
    tee_write_trailer, /* write_trailer */
};
