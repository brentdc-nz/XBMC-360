...
{
    AVRational pts_info = av_make_q(2997, 125);  /* default: 23.976 fps */
...
AVInputFormat ff_microdvd_demuxer = {
    ...
    0, /* next */
    0, /* raw_codec_id */
    sizeof(MicroDVDContext), /* priv_data_size */
    microdvd_probe, /* read_probe */
    microdvd_read_header, /* read_header */
    microdvd_read_packet, /* read_packet */
    microdvd_read_close, /* read_close */
    0, /* read_seek */
    0, /* read_timestamp */
    0, /* read_play */
    0, /* read_pause */
    microdvd_read_seek, /* read_seek2 */
};
