...
static const AVOption options[] = {
    ...
    {"user-agent", "override User-Agent header", OFFSET(user_agent), AV_OPT_TYPE_STRING, { 0, 0, NULL }, 0, 0, DEC},
...
URLProtocol ff_http_protocol = {
    ...
    http_open, /* url_open */
    http_read, /* url_read */
    http_write, /* url_write */
    http_seek, /* url_seek */
    http_close, /* url_close */
    0, /* next */
    0, /* url_read_pause */
    0, /* url_read_seek */
    http_get_file_handle, /* url_get_file_handle */
    0, /* url_get_multi_file_handle */
    http_shutdown, /* url_shutdown */
    sizeof(HTTPContext), /* priv_data_size */
    &http_context_class, /* priv_data_class */
...
URLProtocol ff_https_protocol = {
    ...
    http_shutdown, /* url_shutdown */
    sizeof(HTTPContext), /* priv_data_size */
    &https_context_class, /* priv_data_class */
    URL_PROTOCOL_FLAG_NETWORK, /* flags */
};
#endif
...
URLProtocol ff_httpproxy_protocol = {
    "httpproxy", /* name */
    http_proxy_open, /* url_open */
    http_buf_read, /* url_read */
    http_proxy_write, /* url_write */
    0, /* url_seek */
    http_proxy_close, /* url_close */
    0, /* next */
    0, /* url_read_pause */
    0, /* url_read_seek */
    http_get_file_handle, /* url_get_file_handle */
