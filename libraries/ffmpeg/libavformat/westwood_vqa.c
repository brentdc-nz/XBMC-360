...
AVInputFormat ff_wsvqa_demuxer = {
    "wsvqa", /* name */
    NULL_IF_CONFIG_SMALL("Westwood Studios VQA"), /* long_name */
    0, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(WsVqaDemuxContext), /* priv_data_size */
    wsvqa_probe, /* read_probe */
    wsvqa_read_header, /* read_header */
    wsvqa_read_packet, /* read_packet */
};
