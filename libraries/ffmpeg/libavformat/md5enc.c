...
AVOutputFormat ff_md5_muxer = {
    "md5", /* name */
    NULL_IF_CONFIG_SMALL("MD5 testing"), /* long_name */
    0, /* mime_type */
    0, /* extensions */
...
AVOutputFormat ff_framemd5_muxer = {
    "framemd5", /* name */
    NULL_IF_CONFIG_SMALL("Per-frame MD5 testing"), /* long_name */
    0, /* mime_type */
    0, /* extensions */
    AV_CODEC_ID_PCM_S16LE, /* audio_codec */
    AV_CODEC_ID_RAWVIDEO, /* video_codec */
    ...
    0, /* next */
    sizeof(struct MD5Context), /* priv_data_size */
    framemd5_write_header, /* write_header */
    framemd5_write_packet, /* write_packet */
    framemd5_write_trailer, /* write_trailer */
};
#endif
