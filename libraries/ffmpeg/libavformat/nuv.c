...
AVInputFormat ff_nuv_demuxer = {
    "nuv", /* name */
    NULL_IF_CONFIG_SMALL("NuppelVideo"), /* long_name */
    ...
    0, /* next */
    0, /* raw_codec_id */
    sizeof(NUVContext), /* priv_data_size */
    nuv_probe, /* read_probe */
    nuv_header, /* read_header */
    nuv_packet, /* read_packet */
    0, /* read_close */
    0, /* read_seek */
    nuv_read_dts, /* read_timestamp */
};
