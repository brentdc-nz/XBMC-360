...
#if CONFIG_ASF_MUXER
static const AVCodecTag *const _ff_asfenc_tags_3[] = { codec_asf_bmp_tags, ff_codec_bmp_tags, ff_codec_wav_tags, 0 };
AVOutputFormat ff_asf_muxer = {
    "asf", /* name */
    NULL_IF_CONFIG_SMALL("ASF (Advanced / Active Streaming Format)"), /* long_name */
    "video/x-ms-asf", /* mime_type */
    "asf,wmv,wma", /* extensions */
    AV_CODEC_ID_WMAV2, /* audio_codec */
    AV_CODEC_ID_MSMPEG4V3, /* video_codec */
    0, /* subtitle_codec */
    AVFMT_GLOBALHEADER, /* flags */
    _ff_asfenc_tags_3, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    sizeof(ASFContext), /* priv_data_size */
    asf_write_header, /* write_header */
    asf_write_packet, /* write_packet */
    asf_write_trailer, /* write_trailer */
};
#endif /* CONFIG_ASF_MUXER */

#if CONFIG_ASF_STREAM_MUXER
static const AVCodecTag *const _ff_asfenc_tags_4[] = { codec_asf_bmp_tags, ff_codec_bmp_tags, ff_codec_wav_tags, 0 };
AVOutputFormat ff_asf_stream_muxer = {
    ...
    0, /* subtitle_codec */
    AVFMT_GLOBALHEADER, /* flags */
    _ff_asfenc_tags_4, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    sizeof(ASFContext), /* priv_data_size */
    asf_write_stream_header, /* write_header */
    asf_write_packet, /* write_packet */
    asf_write_trailer, /* write_trailer */
};
