...
AVInputFormat ff_mmf_demuxer = {
    "mmf", /* name */
    NULL_IF_CONFIG_SMALL("Yamaha SMAF"), /* long_name */
    ...
    0, /* next */
    0, /* raw_codec_id */
    sizeof(MMFContext), /* priv_data_size */
    mmf_probe, /* read_probe */
    mmf_read_header, /* read_header */
    mmf_read_packet, /* read_packet */
};
#endif
#if CONFIG_MMF_MUXER
AVOutputFormat ff_mmf_muxer = {
    "mmf", /* name */
    NULL_IF_CONFIG_SMALL("Yamaha SMAF"), /* long_name */
    "application/vnd.smaf", /* mime_type */
    "mmf", /* extensions */
    AV_CODEC_ID_ADPCM_YAMAHA, /* audio_codec */
    ...
    0, /* next */
    sizeof(MMFContext), /* priv_data_size */
    mmf_write_header, /* write_header */
    ff_raw_write_packet, /* write_packet */
    mmf_write_trailer, /* write_trailer */
};
#endif
