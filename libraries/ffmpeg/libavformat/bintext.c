...
static const AVOption options[] = {
    ...
    { "video_size", "set video size, such as 640x480 or hd720.", OFFSET(video_size), AV_OPT_TYPE_STRING, { 0 }, 0, 0, AV_OPT_FLAG_DECODING_PARAM },
    { "framerate", "set framerate (frames per second)", OFFSET(framerate), AV_OPT_TYPE_STRING, { 0 }, 0, 0, AV_OPT_FLAG_DECODING_PARAM },
    { NULL },
};

#ifdef MSC_STRUCTS
/* C89: Cannot use compound literal (const AVClass[1]){{...}} in initializer.
 * Define static AVClass instances instead. */
static const AVClass bintext_class = {
    "Binary text demuxer",
    av_default_item_name,
    options,
    LIBAVUTIL_VERSION_INT,
};
static const AVClass xbin_class = {
    "eXtended BINary text (XBIN) demuxer",
    av_default_item_name,
    options,
    LIBAVUTIL_VERSION_INT,
};
static const AVClass adf_class = {
    "Artworx Data Format demuxer",
    av_default_item_name,
    options,
    LIBAVUTIL_VERSION_INT,
};
static const AVClass idf_class = {
    "iCE Draw File demuxer",
    av_default_item_name,
    options,
    LIBAVUTIL_VERSION_INT,
};
#define CLASS_BINTEXT &bintext_class
#define CLASS_XBIN    &xbin_class
#define CLASS_ADF     &adf_class
#define CLASS_IDF     &idf_class
#else
#define CLASS(name) \
(const AVClass[1]){{ \
    .class_name     = name, \
...
#define CLASS_BINTEXT CLASS("Binary text demuxer")
#define CLASS_XBIN    CLASS("eXtended BINary text (XBIN) demuxer")
#define CLASS_ADF     CLASS("Artworx Data Format demuxer")
#define CLASS_IDF     CLASS("iCE Draw File demuxer")
#endif
...
AVInputFormat ff_bintext_demuxer = {
    ...
    "bin", /* extensions */
    0, /* codec_tag */
    CLASS_BINTEXT, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(BinDemuxContext), /* priv_data_size */
    0, /* read_probe */
    bintext_read_header, /* read_header */
...
AVInputFormat ff_xbin_demuxer = {
    "xbin", /* name */
    NULL_IF_CONFIG_SMALL("eXtended BINary text (XBIN)"), /* long_name */
    0, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    CLASS_XBIN, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(BinDemuxContext), /* priv_data_size */
    xbin_probe, /* read_probe */
    xbin_read_header, /* read_header */
    read_packet, /* read_packet */
};
#endif
...
AVInputFormat ff_adf_demuxer = {
    "adf", /* name */
    NULL_IF_CONFIG_SMALL("Artworx Data Format"), /* long_name */
    0, /* flags */
    "adf", /* extensions */
    0, /* codec_tag */
    CLASS_ADF, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(BinDemuxContext), /* priv_data_size */
    0, /* read_probe */
    adf_read_header, /* read_header */
    read_packet, /* read_packet */
};
#endif
...
AVInputFormat ff_idf_demuxer = {
    "idf", /* name */
    NULL_IF_CONFIG_SMALL("iCE Draw File"), /* long_name */
    0, /* flags */
    "idf", /* extensions */
    0, /* codec_tag */
    CLASS_IDF, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(BinDemuxContext), /* priv_data_size */
    idf_probe, /* read_probe */
    idf_read_header, /* read_header */
    read_packet, /* read_packet */
};
#endif
