    ...
    if (!img->is_pipe) {
        ...
        for (i = 0; i < 4; i++) {
            ...
            if (!img->split_planes || i+1 >= desc->nb_components)
                break;
            static int _cla_img2enc_1[] = {'U','V','A','x'};
            filename[strlen(filename) - 1] = _cla_img2enc_1[i];
        }
    } else {
        pb[0] = s->pb;
    }
...
static const AVOption muxoptions[] = {
    { "updatefirst",  "update the first image file",      OFFSET(updatefirst), AV_OPT_TYPE_INT, { 0 }, 0,       1, ENC },
    { "start_number", "set first number in the sequence", OFFSET(img_number), AV_OPT_TYPE_INT,  { 1 }, 1, INT_MAX, ENC },
    { NULL },
};

#if CONFIG_IMAGE2_MUXER
static const AVClass img2mux_class = {
    "image2 muxer", /* class_name */
...
AVOutputFormat ff_image2_muxer = {
    ...
    "bmp,dpx,jls,jpeg,jpg,ljpg,pam,pbm,pcx,pgm,pgmyuv,png,"
                      ...
                      "sunras,xbm,xface", /* extensions */
    0, /* audio_codec */
    AV_CODEC_ID_MJPEG, /* video_codec */
    0, /* subtitle_codec */
    AVFMT_NOTIMESTAMPS | AVFMT_NODIMENSIONS | AVFMT_NOFILE, /* flags */
    0, /* codec_tag */
    &img2mux_class, /* priv_class */
    0, /* next */
    sizeof(VideoMuxData), /* priv_data_size */
...
AVOutputFormat ff_image2pipe_muxer = {
    ...
    AV_CODEC_ID_MJPEG, /* video_codec */
    0, /* subtitle_codec */
    AVFMT_NOTIMESTAMPS | AVFMT_NODIMENSIONS, /* flags */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    sizeof(VideoMuxData), /* priv_data_size */
