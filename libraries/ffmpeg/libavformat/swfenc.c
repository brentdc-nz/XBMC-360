...
AVOutputFormat ff_swf_muxer = {
    "swf", /* name */
    NULL_IF_CONFIG_SMALL("SWF (ShockWave Flash)"), /* long_name */
    "application/x-shockwave-flash", /* mime_type */
    "swf", /* extensions */
    AV_CODEC_ID_MP3, /* audio_codec */
    ...
    0, /* priv_class */
    0, /* next */
    sizeof(SWFContext), /* priv_data_size */
    swf_write_header, /* write_header */
    swf_write_packet, /* write_packet */
    swf_write_trailer, /* write_trailer */
};
#endif
#if CONFIG_AVM2_MUXER
AVOutputFormat ff_avm2_muxer = {
    "avm2", /* name */
    NULL_IF_CONFIG_SMALL("SWF (ShockWave Flash) (AVM2)"), /* long_name */
    "application/x-shockwave-flash", /* mime_type */
    0, /* extensions */
    AV_CODEC_ID_MP3, /* audio_codec */
    AV_CODEC_ID_FLV1, /* video_codec */
