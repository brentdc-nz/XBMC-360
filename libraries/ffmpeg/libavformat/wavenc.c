...
static const AVClass wav_muxer_class = {
    "WAV muxer", /* class_name */
    av_default_item_name, /* item_name */
    options, /* option */
    LIBAVUTIL_VERSION_INT, /* version */
};

static const AVCodecTag *const _ff_wavenc_tags_42[] = { ff_codec_wav_tags, 0 };
AVOutputFormat ff_wav_muxer = {
    "wav", /* name */
    NULL_IF_CONFIG_SMALL("WAV / WAVE (Waveform Audio)"), /* long_name */
    "audio/x-wav", /* mime_type */
    "wav", /* extensions */
    AV_CODEC_ID_PCM_S16LE, /* audio_codec */
    AV_CODEC_ID_NONE, /* video_codec */
    0, /* subtitle_codec */
    AVFMT_TS_NONSTRICT, /* flags */
    _ff_wavenc_tags_42, /* codec_tag */
    &wav_muxer_class, /* priv_class */
    0, /* next */
    sizeof(WAVMuxContext), /* priv_data_size */
    wav_write_header, /* write_header */
    wav_write_packet, /* write_packet */
    wav_write_trailer, /* write_trailer */
};
...
static const AVCodecTag *const _ff_wavenc_tags_43[] = { ff_codec_wav_tags, 0 };
AVOutputFormat ff_w64_muxer = {
    "w64", /* name */
    NULL_IF_CONFIG_SMALL("Sony Wave64"), /* long_name */
    0, /* mime_type */
    "w64", /* extensions */
    AV_CODEC_ID_PCM_S16LE, /* audio_codec */
    AV_CODEC_ID_NONE, /* video_codec */
    0, /* subtitle_codec */
    AVFMT_TS_NONSTRICT, /* flags */
    _ff_wavenc_tags_43, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    sizeof(WAVMuxContext), /* priv_data_size */
    w64_write_header, /* write_header */
    wav_write_packet, /* write_packet */
    w64_write_trailer, /* write_trailer */
};
