...
static const AVOption cdxl_options[] = {
    ...
    { "framerate",   "", OFFSET(framerate),   AV_OPT_TYPE_STRING, { 0 },  0, 0,       AV_OPT_FLAG_DECODING_PARAM },
    { NULL },
};

static const AVClass cdxl_demuxer_class = {
    "CDXL demuxer", /* class_name */
...
AVInputFormat ff_cdxl_demuxer = {
    ...
    "cdxl,xl", /* extensions */
    0, /* codec_tag */
    &cdxl_demuxer_class, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(CDXLDemuxContext), /* priv_data_size */
    cdxl_read_probe, /* read_probe */
    cdxl_read_header, /* read_header */
    cdxl_read_packet, /* read_packet */
};
