...
static const AVClass ffrtmpcrypt_class = {
    "ffrtmpcrypt", /* class_name */
    av_default_item_name, /* item_name */
    ffrtmpcrypt_options, /* option */
...
URLProtocol ff_ffrtmpcrypt_protocol = {
    ...
    rtmpe_open, /* url_open */
    rtmpe_read, /* url_read */
    rtmpe_write, /* url_write */
    0, /* url_seek */
    rtmpe_close, /* url_close */
    0, /* next */
    0, /* url_read_pause */
    0, /* url_read_seek */
    ...
    0, /* url_shutdown */
    sizeof(RTMPEContext), /* priv_data_size */
    &ffrtmpcrypt_class, /* priv_data_class */
