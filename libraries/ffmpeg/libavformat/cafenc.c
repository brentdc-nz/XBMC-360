...
static const AVCodecTag *const _ff_cafenc_tags_11[] = { ff_codec_caf_tags, 0 };
AVOutputFormat ff_caf_muxer = {
    "caf", /* name */
    NULL_IF_CONFIG_SMALL("Apple CAF (Core Audio Format)"), /* long_name */
    "audio/x-caf", /* mime_type */
    "caf", /* extensions */
    AV_CODEC_ID_PCM_S16BE, /* audio_codec */
    AV_CODEC_ID_NONE, /* video_codec */
    0, /* subtitle_codec */
    0, /* flags */
    _ff_cafenc_tags_11, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    sizeof(CAFContext), /* priv_data_size */
    caf_write_header, /* write_header */
    caf_write_packet, /* write_packet */
    caf_write_trailer, /* write_trailer */
};
