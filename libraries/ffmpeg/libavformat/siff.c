...
AVInputFormat ff_siff_demuxer = {
    "siff", /* name */
    NULL_IF_CONFIG_SMALL("Beam Software SIFF"), /* long_name */
    0, /* flags */
    "vb,son", /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(SIFFContext), /* priv_data_size */
    siff_probe, /* read_probe */
    siff_read_header, /* read_header */
    siff_read_packet, /* read_packet */
};
