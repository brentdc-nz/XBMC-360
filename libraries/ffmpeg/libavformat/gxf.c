...
static void gxf_track_tags(AVIOContext *pb, int *len, struct gxf_stream_info *si) {
    si->frames_per_second = av_make_q(0, 0);
...
static int gxf_header(AVFormatContext *s) {
    ...
    if (!main_timebase.num || !main_timebase.den)
        main_timebase = av_make_q(1001, 60000);
...
AVInputFormat ff_gxf_demuxer = {
    ...
    0, /* next */
    0, /* raw_codec_id */
    sizeof(struct gxf_stream_info), /* priv_data_size */
    gxf_probe, /* read_probe */
    gxf_header, /* read_header */
    gxf_packet, /* read_packet */
    0, /* read_close */
    gxf_seek, /* read_seek */
    gxf_read_timestamp, /* read_timestamp */
};
