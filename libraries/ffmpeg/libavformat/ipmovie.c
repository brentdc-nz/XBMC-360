...
AVInputFormat ff_ipmovie_demuxer = {
    "ipmovie", /* name */
    NULL_IF_CONFIG_SMALL("Interplay MVE"), /* long_name */
    0, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(IPMVEContext), /* priv_data_size */
    ipmovie_probe, /* read_probe */
    ipmovie_read_header, /* read_header */
    ipmovie_read_packet, /* read_packet */
};
