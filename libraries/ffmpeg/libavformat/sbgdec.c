...
AVInputFormat ff_sbg_demuxer = {
    "sbg", /* name */
    NULL_IF_CONFIG_SMALL("SBaGen binaural beats script"), /* long_name */
    0, /* flags */
    "sbg", /* extensions */
    0, /* codec_tag */
    &sbg_demuxer_class, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(struct sbg_demuxer), /* priv_data_size */
    sbg_read_probe, /* read_probe */
    sbg_read_header, /* read_header */
    sbg_read_packet, /* read_packet */
    0, /* read_close */
    sbg_read_seek, /* read_seek */
    0, /* read_timestamp */
    0, /* read_play */
    0, /* read_pause */
    sbg_read_seek2, /* read_seek2 */
};
