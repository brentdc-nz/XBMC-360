...
static const AVCodecTag *const _ff_astdec_tags_5[] = { ff_codec_ast_tags, 0 };
AVInputFormat ff_ast_demuxer = {
    "ast", /* name */
    NULL_IF_CONFIG_SMALL("AST (Audio Stream)"), /* long_name */
    AVFMT_GENERIC_INDEX, /* flags */
    "ast", /* extensions */
    _ff_astdec_tags_5, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    0, /* priv_data_size */
    ast_probe, /* read_probe */
    ast_read_header, /* read_header */
    ast_read_packet, /* read_packet */
};
