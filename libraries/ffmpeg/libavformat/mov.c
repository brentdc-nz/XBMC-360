...
static int mov_read_chpl(MOVContext *c, AVIOContext *pb, MOVAtom atom)
{
    ...
    for (i = 0; i < nb_chapters; i++) {
        ...
        str[str_len] = 0;
        avpriv_new_chapter(c->fc, i, av_make_q(1, 10000000), start, AV_NOPTS_VALUE, str);
    }
    return 0;
}
...
static int mov_read_dac3(MOVContext *c, AVIOContext *pb, MOVAtom atom)
{
    ...
    { static int _cla_mov_1[] = {2,1,2,3,3,4,4,5};
    st->codec->channels = _cla_mov_1[acmod] + lfeon; }
...
int ff_mov_read_stsd_entries(MOVContext *c, AVIOContext *pb, int entries)
{
    ...
    for (pseudo_stream_id = 0;
        ...
        if (st->codec->codec_type==AVMEDIA_TYPE_VIDEO) {
            ...
            MOVAtom fake_atom = { size - (avio_tell(pb) - start_pos) };
...
static int mov_read_packet(AVFormatContext *s, AVPacket *pkt)
{
 ...
 retry:
    ...
    if (!sample) {
        ...
        { MOVAtom _tmp_atom;
          _tmp_atom.type = AV_RL32("root");
          _tmp_atom.size = INT64_MAX;
        if (mov_read_default(mov, s->pb, _tmp_atom) < 0 ||
            url_feof(s->pb))
            return AVERROR_EOF; }
...
static const AVClass class = {
    "mov,mp4,m4a,3gp,3g2,mj2", /* class_name */
...
AVInputFormat ff_mov_demuxer = {
    "mov,mp4,m4a,3gp,3g2,mj2", /* name */
    NULL_IF_CONFIG_SMALL("QuickTime / MOV"), /* long_name */
    AVFMT_NO_BYTE_SEEK, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    &class, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(MOVContext), /* priv_data_size */
    mov_probe, /* read_probe */
    mov_read_header, /* read_header */
    mov_read_packet, /* read_packet */
    mov_read_close, /* read_close */
    mov_read_seek, /* read_seek */
};
