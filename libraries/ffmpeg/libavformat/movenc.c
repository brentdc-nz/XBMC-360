...
static int mov_write_chpl_tag(AVIOContext *pb, AVFormatContext *s)
{
    ...
    for (i = 0; i < nb_chapters; i++) {
        ...
        AVDictionaryEntry *t;
        avio_wb64(pb, av_rescale_q(c->start, c->time_base, av_make_q(1, 10000000)));
...
static void mov_create_chapter_track(AVFormatContext *s, int tracknum)
{
    ...
    AVPacket pkt = { tracknum, AV_PKT_FLAG_KEY };
    int i, len;
    ...
    for (i = 0; i < s->nb_chapters; i++) {
        ...
        int64_t end = av_rescale_q(c->end, c->time_base, av_make_q(1, MOV_TIMESCALE));
        pkt.pts = pkt.dts = av_rescale_q(c->start, c->time_base, av_make_q(1, MOV_TIMESCALE));
...
static int mov_create_timecode_track(AVFormatContext *s, int index, int src_index, const char *tcstr)
{
    ...
    AVTimecode tc;
    AVPacket pkt    = {index, AV_PKT_FLAG_KEY, 4};
...
#if CONFIG_MOV_MUXER
MOV_CLASS(mov)
static const AVCodecTag *const _ff_movenc_tags_18[] = { ff_codec_movvideo_tags, ff_codec_movaudio_tags, 0 };
AVOutputFormat ff_mov_muxer = {
    "mov", /* name */
    NULL_IF_CONFIG_SMALL("QuickTime / MOV"), /* long_name */
    0, /* mime_type */
    "mov", /* extensions */
    AV_CODEC_ID_AAC, /* audio_codec */
    CONFIG_LIBX264_ENCODER ?
                         AV_CODEC_ID_H264 : AV_CODEC_ID_MPEG4, /* video_codec */
    0, /* subtitle_codec */
    AVFMT_GLOBALHEADER | AVFMT_ALLOW_FLUSH, /* flags */
    _ff_movenc_tags_18, /* codec_tag */
    &mov_muxer_class, /* priv_class */
    0, /* next */
    sizeof(MOVMuxContext), /* priv_data_size */
    mov_write_header, /* write_header */
    mov_write_packet, /* write_packet */
    mov_write_trailer, /* write_trailer */
};
#endif
#if CONFIG_TGP_MUXER
MOV_CLASS(tgp)
static const AVCodecTag *const _ff_movenc_tags_19[] = { codec_3gp_tags, 0 };
AVOutputFormat ff_tgp_muxer = {
    "3gp", /* name */
    NULL_IF_CONFIG_SMALL("3GP (3GPP file format)"), /* long_name */
    0, /* mime_type */
    "3gp", /* extensions */
    AV_CODEC_ID_AMR_NB, /* audio_codec */
    AV_CODEC_ID_H263, /* video_codec */
    0, /* subtitle_codec */
    AVFMT_GLOBALHEADER | AVFMT_ALLOW_FLUSH, /* flags */
    _ff_movenc_tags_19, /* codec_tag */
    &tgp_muxer_class, /* priv_class */
    0, /* next */
    sizeof(MOVMuxContext), /* priv_data_size */
    mov_write_header, /* write_header */
    mov_write_packet, /* write_packet */
...
#if CONFIG_MP4_MUXER
MOV_CLASS(mp4)
static const AVCodecTag *const _ff_movenc_tags_20[] = { ff_mp4_obj_type, 0 };
AVOutputFormat ff_mp4_muxer = {
    "mp4", /* name */
    NULL_IF_CONFIG_SMALL("MP4 (MPEG-4 Part 14)"), /* long_name */
    "application/mp4", /* mime_type */
    "mp4", /* extensions */
    AV_CODEC_ID_AAC, /* audio_codec */
    CONFIG_LIBX264_ENCODER ?
                         AV_CODEC_ID_H264 : AV_CODEC_ID_MPEG4, /* video_codec */
    0, /* subtitle_codec */
    AVFMT_GLOBALHEADER | AVFMT_ALLOW_FLUSH, /* flags */
    _ff_movenc_tags_20, /* codec_tag */
    &mp4_muxer_class, /* priv_class */
    0, /* next */
    sizeof(MOVMuxContext), /* priv_data_size */
    mov_write_header, /* write_header */
    mov_write_packet, /* write_packet */
...
#if CONFIG_PSP_MUXER
MOV_CLASS(psp)
static const AVCodecTag *const _ff_movenc_tags_21[] = { ff_mp4_obj_type, 0 };
AVOutputFormat ff_psp_muxer = {
    "psp", /* name */
    NULL_IF_CONFIG_SMALL("PSP MP4 (MPEG-4 Part 14)"), /* long_name */
    0, /* mime_type */
    "mp4,psp", /* extensions */
    AV_CODEC_ID_AAC, /* audio_codec */
    CONFIG_LIBX264_ENCODER ?
    ...
    0, /* subtitle_codec */
    AVFMT_GLOBALHEADER | AVFMT_ALLOW_FLUSH, /* flags */
    _ff_movenc_tags_21, /* codec_tag */
    &psp_muxer_class, /* priv_class */
    0, /* next */
    sizeof(MOVMuxContext), /* priv_data_size */
    mov_write_header, /* write_header */
    mov_write_packet, /* write_packet */
...
#if CONFIG_TG2_MUXER
MOV_CLASS(tg2)
static const AVCodecTag *const _ff_movenc_tags_22[] = { codec_3gp_tags, 0 };
AVOutputFormat ff_tg2_muxer = {
    "3g2", /* name */
    NULL_IF_CONFIG_SMALL("3GP2 (3GPP2 file format)"), /* long_name */
    0, /* mime_type */
    "3g2", /* extensions */
    AV_CODEC_ID_AMR_NB, /* audio_codec */
    AV_CODEC_ID_H263, /* video_codec */
    0, /* subtitle_codec */
    AVFMT_GLOBALHEADER | AVFMT_ALLOW_FLUSH, /* flags */
    _ff_movenc_tags_22, /* codec_tag */
    &tg2_muxer_class, /* priv_class */
    0, /* next */
    sizeof(MOVMuxContext), /* priv_data_size */
    mov_write_header, /* write_header */
    mov_write_packet, /* write_packet */
...
MOV_CLASS(ipod)
static const AVCodecTag *const _ff_movenc_tags_23[] = { codec_ipod_tags, 0 };
AVOutputFormat ff_ipod_muxer = {
    "ipod", /* name */
    NULL_IF_CONFIG_SMALL("iPod H.264 MP4 (MPEG-4 Part 14)"), /* long_name */
    "application/mp4", /* mime_type */
    "m4v,m4a", /* extensions */
    AV_CODEC_ID_AAC, /* audio_codec */
    ...
    0, /* subtitle_codec */
    AVFMT_GLOBALHEADER | AVFMT_ALLOW_FLUSH, /* flags */
    _ff_movenc_tags_23, /* codec_tag */
    &ipod_muxer_class, /* priv_class */
    0, /* next */
    sizeof(MOVMuxContext), /* priv_data_size */
    mov_write_header, /* write_header */
    mov_write_packet, /* write_packet */
...
MOV_CLASS(ismv)
static const AVCodecTag *const _ff_movenc_tags_24[] = { ff_mp4_obj_type, 0 };
AVOutputFormat ff_ismv_muxer = {
    "ismv", /* name */
    NULL_IF_CONFIG_SMALL("ISMV/ISMA (Smooth Streaming)"), /* long_name */
    "application/mp4", /* mime_type */
    "ismv,isma", /* extensions */
    AV_CODEC_ID_AAC, /* audio_codec */
    AV_CODEC_ID_H264, /* video_codec */
    0, /* subtitle_codec */
    AVFMT_GLOBALHEADER | AVFMT_ALLOW_FLUSH, /* flags */
    _ff_movenc_tags_24, /* codec_tag */
    &ismv_muxer_class, /* priv_class */
    0, /* next */
    sizeof(MOVMuxContext), /* priv_data_size */
    mov_write_header, /* write_header */
    mov_write_packet, /* write_packet */
...
#if CONFIG_F4V_MUXER
MOV_CLASS(f4v)
static const AVCodecTag *const _ff_movenc_tags_25[] = { codec_f4v_tags, 0 };
AVOutputFormat ff_f4v_muxer = {
    "f4v", /* name */
    NULL_IF_CONFIG_SMALL("F4V Adobe Flash Video"), /* long_name */
    "application/f4v", /* mime_type */
    "f4v", /* extensions */
    AV_CODEC_ID_AAC, /* audio_codec */
    AV_CODEC_ID_H264, /* video_codec */
    0, /* subtitle_codec */
    AVFMT_GLOBALHEADER | AVFMT_ALLOW_FLUSH, /* flags */
    _ff_movenc_tags_25, /* codec_tag */
    &f4v_muxer_class, /* priv_class */
    0, /* next */
    sizeof(MOVMuxContext), /* priv_data_size */
    mov_write_header, /* write_header */
    mov_write_packet, /* write_packet */
