...
static const AVOption rawvideo_options[] = {
    { "video_size", "set frame size", OFFSET(video_size), AV_OPT_TYPE_STRING, { 0 }, 0, 0, DEC },
    { "pixel_format", "set pixel format", OFFSET(pixel_format), AV_OPT_TYPE_STRING, { 0 }, 0, 0, DEC },
    { "framerate", "set frame rate", OFFSET(framerate), AV_OPT_TYPE_STRING, { 0 }, 0, 0, DEC },
    { NULL },
};

static const AVClass rawvideo_demuxer_class = {
    "rawvideo demuxer", /* class_name */
    av_default_item_name, /* item_name */
    rawvideo_options, /* option */
...
AVInputFormat ff_rawvideo_demuxer = {
    ...
    "yuv,cif,qcif,rgb", /* extensions */
    0, /* codec_tag */
    &rawvideo_demuxer_class, /* priv_class */
    0, /* next */
    AV_CODEC_ID_RAWVIDEO, /* raw_codec_id */
    sizeof(RawVideoDemuxerContext), /* priv_data_size */
    0, /* read_probe */
    rawvideo_read_header, /* read_header */
    rawvideo_read_packet, /* read_packet */
};
