...
AVInputFormat ff_ilbc_demuxer = {
    "ilbc", /* name */
    NULL_IF_CONFIG_SMALL("iLBC storage"), /* long_name */
    ...
    0, /* raw_codec_id */
    0, /* priv_data_size */
    ilbc_probe, /* read_probe */
    ilbc_read_header, /* read_header */
    ilbc_read_packet, /* read_packet */
};

AVOutputFormat ff_ilbc_muxer = {
    "ilbc", /* name */
    NULL_IF_CONFIG_SMALL("iLBC storage"), /* long_name */
    "audio/iLBC", /* mime_type */
    "lbc", /* extensions */
    AV_CODEC_ID_ILBC, /* audio_codec */
    0, /* video_codec */
    0, /* subtitle_codec */
    ...
    0, /* next */
    0, /* priv_data_size */
    ilbc_write_header, /* write_header */
    ilbc_write_packet, /* write_packet */
};
