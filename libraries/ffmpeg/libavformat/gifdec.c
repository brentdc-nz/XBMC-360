...
static const AVClass demuxer_class = {
    ...
    0, /* child_next */
    0, /* child_class_next */
    AV_CLASS_CATEGORY_DEMUXER, /* category */
};

AVInputFormat ff_gif_demuxer = {
    "gif", /* name */
    NULL_IF_CONFIG_SMALL("CompuServe Graphics Interchange Format (GIF)"), /* long_name */
    AVFMT_GENERIC_INDEX, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    &demuxer_class, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(GIFDemuxContext), /* priv_data_size */
    gif_probe, /* read_probe */
    gif_read_header, /* read_header */
    gif_read_packet, /* read_packet */
};
