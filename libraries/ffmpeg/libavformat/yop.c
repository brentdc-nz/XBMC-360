...
static int yop_read_header(AVFormatContext *s)
{
    ...
    video_stream->sample_aspect_ratio = av_make_q(1, 2);
...
AVInputFormat ff_yop_demuxer = {
    "yop", /* name */
    NULL_IF_CONFIG_SMALL("Psygnosis YOP"), /* long_name */
    ...
    0, /* next */
    0, /* raw_codec_id */
    sizeof(YopDecContext), /* priv_data_size */
    yop_probe, /* read_probe */
    yop_read_header, /* read_header */
    yop_read_packet, /* read_packet */
    yop_read_close, /* read_close */
    yop_read_seek, /* read_seek */
};
