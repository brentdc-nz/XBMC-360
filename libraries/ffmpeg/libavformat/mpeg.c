...
AVInputFormat ff_mpegps_demuxer = {
    "mpeg", /* name */
    NULL_IF_CONFIG_SMALL("MPEG-PS (MPEG-2 Program Stream)"), /* long_name */
    AVFMT_SHOW_IDS | AVFMT_TS_DISCONT, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(MpegDemuxContext), /* priv_data_size */
    mpegps_probe, /* read_probe */
    mpegps_read_header, /* read_header */
    mpegps_read_packet, /* read_packet */
    0, /* read_close */
    0, /* read_seek */
...
AVInputFormat ff_vobsub_demuxer = {
    "vobsub", /* name */
    NULL_IF_CONFIG_SMALL("VobSub subtitle format"), /* long_name */
    ...
    0, /* raw_codec_id */
    sizeof(MpegDemuxContext), /* priv_data_size */
    vobsub_probe, /* read_probe */
    vobsub_read_header, /* read_header */
    vobsub_read_packet, /* read_packet */
    vobsub_read_close, /* read_close */
    0, /* read_seek */
    0, /* read_timestamp */
    0, /* read_play */
    0, /* read_pause */
    vobsub_read_seek, /* read_seek2 */
};
#endif
