...
AVOutputFormat ff_gif_muxer = {
    "gif", /* name */
    NULL_IF_CONFIG_SMALL("GIF Animation"), /* long_name */
    "image/gif", /* mime_type */
    "gif", /* extensions */
    ...
    0, /* flags */
    0, /* codec_tag */
    &gif_muxer_class, /* priv_class */
    0, /* next */
    sizeof(GIFContext), /* priv_data_size */
    gif_write_header, /* write_header */
    gif_write_packet, /* write_packet */
    gif_write_trailer, /* write_trailer */
};
