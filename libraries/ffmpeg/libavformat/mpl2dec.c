...
AVInputFormat ff_mpl2_demuxer = {
    "mpl2", /* name */
    NULL_IF_CONFIG_SMALL("MPL2 subtitles"), /* long_name */
    0, /* flags */
    "txt,mpl2", /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(MPL2Context), /* priv_data_size */
    mpl2_probe, /* read_probe */
    mpl2_read_header, /* read_header */
    mpl2_read_packet, /* read_packet */
    mpl2_read_close, /* read_close */
    0, /* read_seek */
    0, /* read_timestamp */
    0, /* read_play */
    0, /* read_pause */
    mpl2_read_seek, /* read_seek2 */
};
