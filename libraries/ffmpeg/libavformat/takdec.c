...
AVInputFormat ff_tak_demuxer = {
    "tak", /* name */
    NULL_IF_CONFIG_SMALL("raw TAK"), /* long_name */
    AVFMT_GENERIC_INDEX, /* flags */
    "tak", /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    AV_CODEC_ID_TAK, /* raw_codec_id */
    sizeof(TAKDemuxContext), /* priv_data_size */
    tak_probe, /* read_probe */
    tak_read_header, /* read_header */
    raw_read_packet, /* read_packet */
};
