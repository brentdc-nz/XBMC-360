...
AVInputFormat ff_flic_demuxer = {
    "flic", /* name */
    NULL_IF_CONFIG_SMALL("FLI/FLC/FLX animation"), /* long_name */
    0, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(FlicDemuxContext), /* priv_data_size */
    flic_probe, /* read_probe */
    flic_read_header, /* read_header */
    flic_read_packet, /* read_packet */
};
