...
static const AVOption options[] = {
    ...
    { "cname", "CNAME to include in RTCP SR packets", offsetof(RTPMuxContext, cname), AV_OPT_TYPE_STRING, { 0, 0, NULL }, 0, 0, AV_OPT_FLAG_ENCODING_PARAM },
    { "seq", "Starting sequence number", offsetof(RTPMuxContext, seq), AV_OPT_TYPE_INT, { -1 }, -1, 65535, AV_OPT_FLAG_ENCODING_PARAM },
    { NULL },
};

static const AVClass rtp_muxer_class = {
    "RTP muxer", /* class_name */
            ...
            if (frame_size == 0) {
                ...
                s->max_frames_per_packet =
                        av_rescale_q_rnd(s1->max_delay,
                                         AV_TIME_BASE_Q,
                                         av_make_q(frame_size, st->codec->sample_rate),
                                         AV_ROUND_DOWN);
            }
        }
        if (st->codec->codec_type == AVMEDIA_TYPE_VIDEO) {
            /* FIXME: We should round down here... */
            s->max_frames_per_packet = av_rescale_q(s1->max_delay, av_make_q(1, 1000000), st->codec->time_base);
        }
    }
...
static void rtcp_send_sr(AVFormatContext *s1, int64_t ntp_time)
{
    ...
    rtp_ts = av_rescale_q(ntp_time - s->first_rtcp_ntp_time, av_make_q(1, 1000000),
...
AVOutputFormat ff_rtp_muxer = {
    "rtp", /* name */
    NULL_IF_CONFIG_SMALL("RTP output"), /* long_name */
    0, /* mime_type */
    0, /* extensions */
    AV_CODEC_ID_PCM_MULAW, /* audio_codec */
    AV_CODEC_ID_MPEG4, /* video_codec */
    0, /* subtitle_codec */
    0, /* flags */
    0, /* codec_tag */
    &rtp_muxer_class, /* priv_class */
    0, /* next */
    sizeof(RTPMuxContext), /* priv_data_size */
    rtp_write_header, /* write_header */
    rtp_write_packet, /* write_packet */
    rtp_write_trailer, /* write_trailer */
};
