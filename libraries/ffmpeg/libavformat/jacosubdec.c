...
AVInputFormat ff_jacosub_demuxer = {
    ...
    0, /* next */
    0, /* raw_codec_id */
    sizeof(JACOsubContext), /* priv_data_size */
    jacosub_probe, /* read_probe */
    jacosub_read_header, /* read_header */
    jacosub_read_packet, /* read_packet */
    jacosub_read_close, /* read_close */
    0, /* read_seek */
    0, /* read_timestamp */
    0, /* read_play */
    0, /* read_pause */
    jacosub_read_seek, /* read_seek2 */
};
