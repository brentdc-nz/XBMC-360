...
AVInputFormat ff_pjs_demuxer = {
    "pjs", /* name */
    NULL_IF_CONFIG_SMALL("PJS (Phoenix Japanimation Society) subtitles"), /* long_name */
    0, /* flags */
    "pjs", /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(PJSContext), /* priv_data_size */
    pjs_probe, /* read_probe */
    pjs_read_header, /* read_header */
    pjs_read_packet, /* read_packet */
    pjs_read_close, /* read_close */
    0, /* read_seek */
    0, /* read_timestamp */
    0, /* read_play */
    0, /* read_pause */
    pjs_read_seek, /* read_seek2 */
};
