...
AVInputFormat ff_frm_demuxer = {
    "frm", /* name */
    NULL_IF_CONFIG_SMALL("Megalux Frame"), /* long_name */
    0, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(FrmContext), /* priv_data_size */
    frm_read_probe, /* read_probe */
    frm_read_header, /* read_header */
    frm_read_packet, /* read_packet */
};
