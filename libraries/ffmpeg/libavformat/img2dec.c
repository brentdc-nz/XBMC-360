...
static const AVOption options[] = {
    { "framerate",    "set the video framerate",             OFFSET(framerate),    AV_OPT_TYPE_STRING, { 0 }, 0, 0,       DEC },
    ...
    { "pixel_format", "set video pixel format",              OFFSET(pixel_format), AV_OPT_TYPE_STRING, { 0 }, 0, 0,       DEC },
    ...
    { "video_size",   "set video size",                      OFFSET(video_size),   AV_OPT_TYPE_STRING, { 0 }, 0, 0,       DEC },
...
AVInputFormat ff_image2_demuxer = {
    "image2", /* name */
    NULL_IF_CONFIG_SMALL("image2 sequence"), /* long_name */
    AVFMT_NOFILE, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    &img2_class, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(VideoDemuxData), /* priv_data_size */
    img_read_probe, /* read_probe */
    img_read_header, /* read_header */
    img_read_packet, /* read_packet */
    img_read_close, /* read_close */
    img_read_seek, /* read_seek */
};
#endif
#if CONFIG_IMAGE2PIPE_DEMUXER
static const AVClass img2pipe_class = {
    "image2pipe demuxer", /* class_name */
    av_default_item_name, /* item_name */
    options, /* option */
    LIBAVUTIL_VERSION_INT, /* version */
};
AVInputFormat ff_image2pipe_demuxer = {
    "image2pipe", /* name */
    NULL_IF_CONFIG_SMALL("piped image2 sequence"), /* long_name */
    0, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    &img2pipe_class, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(VideoDemuxData), /* priv_data_size */
    0, /* read_probe */
