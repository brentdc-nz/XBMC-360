...
AVOutputFormat ff_adts_muxer = {
    "adts", /* name */
    NULL_IF_CONFIG_SMALL("ADTS AAC (Advanced Audio Coding)"), /* long_name */
    "audio/aac", /* mime_type */
    "aac,adts", /* extensions */
    ...
    0, /* priv_class */
    0, /* next */
    sizeof(ADTSContext), /* priv_data_size */
    adts_write_header, /* write_header */
    adts_write_packet, /* write_packet */
};
