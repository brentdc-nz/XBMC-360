...
static int decrypt_init(AVFormatContext *s, ID3v2ExtraMeta *em, uint8_t *header)
{
    ...
    { static uint8_t _tmp_uint8_t_238[8] = {0};
    if (!memcmp(oc->r_val, _tmp_uint8_t_238, 8) ||
...
static int oma_read_header(AVFormatContext *s)
{
    ...
    { static const uint8_t _ea3_magic[] = {'E', 'A', '3'};
    if (memcmp(buf, _ea3_magic, 3) || buf[4] != 0 || buf[5] != EA3_HEADER_SIZE) {
...
static const AVCodecTag *const _ff_omadec_tags_28[] = { ff_oma_codec_tags, 0 };
AVInputFormat ff_oma_demuxer = {
    "oma", /* name */
    NULL_IF_CONFIG_SMALL("Sony OpenMG audio"), /* long_name */
    AVFMT_GENERIC_INDEX, /* flags */
    "oma,omg,aa3", /* extensions */
    _ff_omadec_tags_28, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(OMAContext), /* priv_data_size */
    oma_read_probe, /* read_probe */
    oma_read_header, /* read_header */
    oma_read_packet, /* read_packet */
    0, /* read_close */
    oma_read_seek, /* read_seek */
};
