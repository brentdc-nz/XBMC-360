...
AVInputFormat ff_mv_demuxer = {
    "mv", /* name */
    NULL_IF_CONFIG_SMALL("Silicon Graphics Movie"), /* long_name */
    0, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(MvContext), /* priv_data_size */
    mv_probe, /* read_probe */
    mv_read_header, /* read_header */
    mv_read_packet, /* read_packet */
    0, /* read_close */
    mv_read_seek, /* read_seek */
};
