...
static const AVClass av_format_context_class = {
    "AVFormatContext", /* class_name */
    format_to_name, /* item_name */
    options, /* option */
    LIBAVUTIL_VERSION_INT, /* version */
    0, /* log_level_offset_offset */
    0, /* parent_log_context_offset */
    format_child_next, /* child_next */
    format_child_class_next, /* child_class_next */
    AV_CLASS_CATEGORY_MUXER, /* category */
