...
AVInputFormat ff_iff_demuxer = {
    "iff", /* name */
    NULL_IF_CONFIG_SMALL("IFF (Interchange File Format)"), /* long_name */
    AVFMT_GENERIC_INDEX | AVFMT_NO_BYTE_SEEK, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(IffDemuxContext), /* priv_data_size */
    iff_probe, /* read_probe */
    iff_read_header, /* read_header */
    iff_read_packet, /* read_packet */
};
