...
static const AVClass aiff_muxer_class = {
    "AIFF muxer", /* class_name */
    av_default_item_name, /* item_name */
    options, /* option */
    LIBAVUTIL_VERSION_INT, /* version */
};

static const AVCodecTag *const _ff_aiffenc_tags_2[] = { ff_codec_aiff_tags, 0 };
AVOutputFormat ff_aiff_muxer = {
    "aiff", /* name */
    NULL_IF_CONFIG_SMALL("Audio IFF"), /* long_name */
    "audio/aiff", /* mime_type */
    "aif,aiff,afc,aifc", /* extensions */
    AV_CODEC_ID_PCM_S16BE, /* audio_codec */
    AV_CODEC_ID_PNG, /* video_codec */
    0, /* subtitle_codec */
    0, /* flags */
    _ff_aiffenc_tags_2, /* codec_tag */
    &aiff_muxer_class, /* priv_class */
    0, /* next */
    sizeof(AIFFOutputContext), /* priv_data_size */
    aiff_write_header, /* write_header */
    aiff_write_packet, /* write_packet */
    aiff_write_trailer, /* write_trailer */
};
