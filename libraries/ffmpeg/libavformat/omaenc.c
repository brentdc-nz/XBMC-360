...
static const AVCodecTag *const _ff_omaenc_tags_29[] = { ff_oma_codec_tags, 0 };
AVOutputFormat ff_oma_muxer = {
    "oma", /* name */
    NULL_IF_CONFIG_SMALL("Sony OpenMG audio"), /* long_name */
    "audio/x-oma", /* mime_type */
    "oma", /* extensions */
    AV_CODEC_ID_ATRAC3, /* audio_codec */
    0, /* video_codec */
    0, /* subtitle_codec */
    0, /* flags */
    _ff_omaenc_tags_29, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* priv_data_size */
    oma_write_header, /* write_header */
