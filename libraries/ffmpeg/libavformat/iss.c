...
AVInputFormat ff_iss_demuxer = {
    "iss", /* name */
    NULL_IF_CONFIG_SMALL("Funcom ISS"), /* long_name */
    0, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(IssDemuxContext), /* priv_data_size */
    iss_probe, /* read_probe */
    iss_read_header, /* read_header */
    iss_read_packet, /* read_packet */
};
