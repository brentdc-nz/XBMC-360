...
AVInputFormat ff_segafilm_demuxer = {
    "film_cpk", /* name */
    NULL_IF_CONFIG_SMALL("Sega FILM / CPK"), /* long_name */
    0, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(FilmDemuxContext), /* priv_data_size */
    film_probe, /* read_probe */
    film_read_header, /* read_header */
    film_read_packet, /* read_packet */
    film_read_close, /* read_close */
};
