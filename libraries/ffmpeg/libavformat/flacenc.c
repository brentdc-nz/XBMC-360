...
AVOutputFormat ff_flac_muxer = {
    "flac", /* name */
    NULL_IF_CONFIG_SMALL("raw FLAC"), /* long_name */
    "audio/x-flac", /* mime_type */
    "flac", /* extensions */
    ...
    0, /* next */
    0, /* priv_data_size */
    flac_write_header, /* write_header */
    flac_write_packet, /* write_packet */
    flac_write_trailer, /* write_trailer */
};
