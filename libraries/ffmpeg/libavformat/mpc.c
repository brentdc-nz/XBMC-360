...
AVInputFormat ff_mpc_demuxer = {
    "mpc", /* name */
    NULL_IF_CONFIG_SMALL("Musepack"), /* long_name */
    0, /* flags */
    "mpc", /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    ...
    mpc_probe, /* read_probe */
    mpc_read_header, /* read_header */
    mpc_read_packet, /* read_packet */
    mpc_read_close, /* read_close */
    mpc_read_seek, /* read_seek */
};
