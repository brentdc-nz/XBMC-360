...
static const AVClass ffrtmphttp_class = {
    "ffrtmphttp", /* class_name */
    av_default_item_name, /* item_name */
    ffrtmphttp_options, /* option */
    LIBAVUTIL_VERSION_INT, /* version */
};

URLProtocol ff_ffrtmphttp_protocol = {
    "ffrtmphttp", /* name */
    rtmp_http_open, /* url_open */
    rtmp_http_read, /* url_read */
    rtmp_http_write, /* url_write */
    0, /* url_seek */
    rtmp_http_close, /* url_close */
    0, /* next */
    0, /* url_read_pause */
    0, /* url_read_seek */
    ...
    0, /* url_shutdown */
    sizeof(RTMP_HTTPContext), /* priv_data_size */
    &ffrtmphttp_class, /* priv_data_class */
