...
AVInputFormat ff_smush_demuxer = {
    "smush", /* name */
    NULL_IF_CONFIG_SMALL("LucasArts Smush"), /* long_name */
    0, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(SMUSHContext), /* priv_data_size */
    smush_read_probe, /* read_probe */
    smush_read_header, /* read_header */
    smush_read_packet, /* read_packet */
};
