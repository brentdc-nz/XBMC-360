...
AVInputFormat ff_vplayer_demuxer = {
    "vplayer", /* name */
    NULL_IF_CONFIG_SMALL("VPlayer subtitles"), /* long_name */
    0, /* flags */
    "txt", /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(VPlayerContext), /* priv_data_size */
    vplayer_probe, /* read_probe */
    vplayer_read_header, /* read_header */
    vplayer_read_packet, /* read_packet */
    vplayer_read_close, /* read_close */
    0, /* read_seek */
    0, /* read_timestamp */
    0, /* read_play */
    0, /* read_pause */
    vplayer_read_seek, /* read_seek2 */
};
