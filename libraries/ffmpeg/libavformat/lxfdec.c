...
static const AVCodecTag *const _ff_lxfdec_tags_15[] = { lxf_tags, 0 };
AVInputFormat ff_lxf_demuxer = {
    "lxf", /* name */
    NULL_IF_CONFIG_SMALL("VR native stream (LXF)"), /* long_name */
    0, /* flags */
    0, /* extensions */
    _ff_lxfdec_tags_15, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(LXFDemuxContext), /* priv_data_size */
    lxf_probe, /* read_probe */
    lxf_read_header, /* read_header */
    lxf_read_packet, /* read_packet */
};
