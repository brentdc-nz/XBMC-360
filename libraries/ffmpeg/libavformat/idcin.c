...
AVInputFormat ff_idcin_demuxer = {
    "idcin", /* name */
    NULL_IF_CONFIG_SMALL("id Cinematic"), /* long_name */
    ...
    0, /* next */
    0, /* raw_codec_id */
    sizeof(IdcinDemuxContext), /* priv_data_size */
    idcin_probe, /* read_probe */
    idcin_read_header, /* read_header */
    idcin_read_packet, /* read_packet */
    0, /* read_close */
    idcin_read_seek, /* read_seek */
};
