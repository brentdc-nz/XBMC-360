...
static const AVOption aqt_options[] = {
    { "subfps", "set the movie frame rate", OFFSET(frame_rate), AV_OPT_TYPE_RATIONAL, { 0 }, 0, INT_MAX, SD },
    { NULL }
};
...
AVInputFormat ff_aqtitle_demuxer = {
    "aqtitle", /* name */
    NULL_IF_CONFIG_SMALL("AQTitle subtitles"), /* long_name */
    0, /* flags */
    "aqt", /* extensions */
    0, /* codec_tag */
    &aqt_class, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(AQTitleContext), /* priv_data_size */
    aqt_probe, /* read_probe */
    aqt_read_header, /* read_header */
    aqt_read_packet, /* read_packet */
    aqt_read_close, /* read_close */
    0, /* read_seek */
    0, /* read_timestamp */
    0, /* read_play */
    0, /* read_pause */
    aqt_read_seek, /* read_seek2 */
};
