...
static int asf_read_marker(AVFormatContext *s, int64_t size)
{
    ...
    for (i = 0; i < count; i++) {
        ...
        if ((ret = avio_get_str16le(pb, name_len * 2, name,
            ...
            avio_skip(pb, name_len - ret);
        avpriv_new_chapter(s, i, av_make_q(1, 10000000), pres_time,
                           AV_NOPTS_VALUE, name);
    }
...
AVInputFormat ff_asf_demuxer = {
    ...
    AVFMT_NOBINSEARCH | AVFMT_NOGENSEARCH, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    &asf_class, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(ASFContext), /* priv_data_size */
    asf_probe, /* read_probe */
    asf_read_header, /* read_header */
    asf_read_packet, /* read_packet */
    asf_read_close, /* read_close */
    asf_read_seek, /* read_seek */
    asf_read_pts, /* read_timestamp */
};
