...
AVInputFormat ff_webvtt_demuxer = {
    ...
    0, /* next */
    0, /* raw_codec_id */
    sizeof(WebVTTContext), /* priv_data_size */
    webvtt_probe, /* read_probe */
    webvtt_read_header, /* read_header */
    webvtt_read_packet, /* read_packet */
    webvtt_read_close, /* read_close */
    0, /* read_seek */
    0, /* read_timestamp */
    0, /* read_play */
    0, /* read_pause */
    webvtt_read_seek, /* read_seek2 */
};
