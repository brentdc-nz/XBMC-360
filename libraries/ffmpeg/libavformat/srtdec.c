...
AVInputFormat ff_srt_demuxer = {
    ...
    0, /* next */
    0, /* raw_codec_id */
    sizeof(SRTContext), /* priv_data_size */
    srt_probe, /* read_probe */
    srt_read_header, /* read_header */
    srt_read_packet, /* read_packet */
    srt_read_close, /* read_close */
    0, /* read_seek */
    0, /* read_timestamp */
    0, /* read_play */
    0, /* read_pause */
    srt_read_seek, /* read_seek2 */
};
