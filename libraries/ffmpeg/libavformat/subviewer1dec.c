...
AVInputFormat ff_subviewer1_demuxer = {
    "subviewer1", /* name */
    NULL_IF_CONFIG_SMALL("SubViewer v1 subtitle format"), /* long_name */
    0, /* flags */
    "sub", /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(SubViewer1Context), /* priv_data_size */
    subviewer1_probe, /* read_probe */
    subviewer1_read_header, /* read_header */
    subviewer1_read_packet, /* read_packet */
    subviewer1_read_close, /* read_close */
    0, /* read_seek */
    0, /* read_timestamp */
    0, /* read_play */
    0, /* read_pause */
    subviewer1_read_seek, /* read_seek2 */
};
