...
static const AVOption options[] = {
    {"start_number",  "set first number in the sequence",        OFFSET(sequence),AV_OPT_TYPE_INT64,  { 0 },     0, INT64_MAX, E},
    {"hls_time",      "set segment length in seconds",           OFFSET(time),    AV_OPT_TYPE_FLOAT,  { 0 },     0, FLT_MAX, E},
    {"hls_list_size", "set maximum number of playlist entries",  OFFSET(size),    AV_OPT_TYPE_INT,    { 5 },     0, INT_MAX, E},
    {"hls_wrap",      "set number after which the index wraps",  OFFSET(wrap),    AV_OPT_TYPE_INT,    { 0 },     0, INT_MAX, E},
    { NULL },
};

static const AVClass hls_class = {
    "hls muxer", /* class_name */
...
AVOutputFormat ff_hls_muxer = {
    "hls", /* name */
    NULL_IF_CONFIG_SMALL("Apple HTTP Live Streaming"), /* long_name */
    0, /* mime_type */
    "m3u8", /* extensions */
    AV_CODEC_ID_MP2, /* audio_codec */
    AV_CODEC_ID_MPEG2VIDEO, /* video_codec */
    0, /* subtitle_codec */
    AVFMT_NOFILE | AVFMT_ALLOW_FLUSH, /* flags */
    0, /* codec_tag */
    &hls_class, /* priv_class */
    0, /* next */
    sizeof(HLSContext), /* priv_data_size */
    hls_write_header, /* write_header */
    hls_write_packet, /* write_packet */
    hls_write_trailer, /* write_trailer */
};
