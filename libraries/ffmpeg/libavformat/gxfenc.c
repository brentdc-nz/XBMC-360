...
static int gxf_write_header(AVFormatContext *s)
{
    ...
    if (ff_audio_interleave_init(s, GXF_samples_per_frame, av_make_q(1, 48000)) < 0)
        return -1;
...
AVOutputFormat ff_gxf_muxer = {
    "gxf", /* name */
    NULL_IF_CONFIG_SMALL("GXF (General eXchange Format)"), /* long_name */
    0, /* mime_type */
    "gxf", /* extensions */
    ...
    0, /* priv_class */
    0, /* next */
    sizeof(GXFContext), /* priv_data_size */
    gxf_write_header, /* write_header */
    gxf_write_packet, /* write_packet */
    gxf_write_trailer, /* write_trailer */
    gxf_interleave_packet, /* interleave_packet */
};
