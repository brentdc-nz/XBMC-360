...
{"timeout", "timeout of socket i/o operations", OFFSET(rw_timeout), AV_OPT_TYPE_INT, { 0 }, 0, INT_MAX, D|E },
...
URLProtocol ff_tcp_protocol = {
    ...
    0, /* url_read_pause */
    0, /* url_read_seek */
    tcp_get_file_handle, /* url_get_file_handle */
    0, /* url_get_multi_file_handle */
    tcp_shutdown, /* url_shutdown */
    sizeof(TCPContext), /* priv_data_size */
    &tcp_context_class, /* priv_data_class */
