...
static int mpsub_read_header(AVFormatContext *s)
{
    ...
    AVStream *st;
    AVBPrint buf;
    AVRational pts_info = av_make_q(100, 1); // ts based by default
    int res = 0;
...
AVInputFormat ff_mpsub_demuxer = {
    "mpsub", /* name */
    NULL_IF_CONFIG_SMALL("MPlayer subtitles"), /* long_name */
    0, /* flags */
    "sub", /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(MPSubContext), /* priv_data_size */
    mpsub_probe, /* read_probe */
    mpsub_read_header, /* read_header */
    mpsub_read_packet, /* read_packet */
    mpsub_read_close, /* read_close */
    0, /* read_seek */
    0, /* read_timestamp */
    0, /* read_play */
    0, /* read_pause */
    mpsub_read_seek, /* read_seek2 */
};
