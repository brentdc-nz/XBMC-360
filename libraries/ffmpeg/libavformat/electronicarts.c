...
AVInputFormat ff_ea_demuxer = {
    "ea", /* name */
    NULL_IF_CONFIG_SMALL("Electronic Arts Multimedia"), /* long_name */
    0, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(EaDemuxContext), /* priv_data_size */
    ea_probe, /* read_probe */
    ea_read_header, /* read_header */
    ea_read_packet, /* read_packet */
};
