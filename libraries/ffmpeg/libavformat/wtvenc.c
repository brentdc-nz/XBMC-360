...
{
    AVRational dar = av_mul_q(st->sample_aspect_ratio, av_make_q(st->codec->width, st->codec->height));
...
static const AVCodecTag *const _ff_wtvenc_tags_44[] = { ff_codec_bmp_tags,
                                                    ff_codec_wav_tags, 0 };
