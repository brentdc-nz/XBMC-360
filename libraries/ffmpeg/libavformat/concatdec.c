...
static const AVOption options[] = {
    { "safe", "enable safe mode",
      OFFSET(safe), AV_OPT_TYPE_INT, { -1 }, -1, 1, DEC },
    { NULL }
};

static const AVClass concat_class = {
    "concat demuxer", /* class_name */
...
AVInputFormat ff_concat_demuxer = {
    "concat", /* name */
    NULL_IF_CONFIG_SMALL("Virtual concatenation script"), /* long_name */
    0, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    &concat_class, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(ConcatContext), /* priv_data_size */
    concat_probe, /* read_probe */
    concat_read_header, /* read_header */
    concat_read_packet, /* read_packet */
    concat_read_close, /* read_close */
};
