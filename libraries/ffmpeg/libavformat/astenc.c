...
static const AVClass ast_muxer_class = {
    "AST muxer", /* class_name */
    av_default_item_name, /* item_name */
    options, /* option */
    LIBAVUTIL_VERSION_INT, /* version */
};

static const AVCodecTag *const _ff_astenc_tags_6[] = { ff_codec_ast_tags, 0 };
AVOutputFormat ff_ast_muxer = {
    "ast", /* name */
    NULL_IF_CONFIG_SMALL("AST (Audio Stream)"), /* long_name */
    0, /* mime_type */
    "ast", /* extensions */
    AV_CODEC_ID_PCM_S16BE_PLANAR, /* audio_codec */
    AV_CODEC_ID_NONE, /* video_codec */
    0, /* subtitle_codec */
    0, /* flags */
    _ff_astenc_tags_6, /* codec_tag */
    &ast_muxer_class, /* priv_class */
    0, /* next */
    sizeof(ASTMuxContext), /* priv_data_size */
    ast_write_header, /* write_header */
    ast_write_packet, /* write_packet */
    ast_write_trailer, /* write_trailer */
};
