...
static const AVCodecTag *const _ff_flvenc_tags_12[] = { flv_video_codec_ids, flv_audio_codec_ids, 0 };
AVOutputFormat ff_flv_muxer = {
    "flv", /* name */
    NULL_IF_CONFIG_SMALL("FLV (Flash Video)"), /* long_name */
    "video/x-flv", /* mime_type */
    "flv", /* extensions */
    CONFIG_LIBMP3LAME ? AV_CODEC_ID_MP3 : AV_CODEC_ID_ADPCM_SWF, /* audio_codec */
    AV_CODEC_ID_FLV1, /* video_codec */
    0, /* subtitle_codec */
    AVFMT_GLOBALHEADER | AVFMT_VARIABLE_FPS |
                      AVFMT_TS_NONSTRICT, /* flags */
    _ff_flvenc_tags_12, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    sizeof(FLVContext), /* priv_data_size */
    flv_write_header, /* write_header */
    flv_write_packet, /* write_packet */
    flv_write_trailer, /* write_trailer */
};
