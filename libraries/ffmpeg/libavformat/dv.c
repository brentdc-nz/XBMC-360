...
static int dv_extract_audio_info(DVDemuxContext* c, uint8_t* frame)
{
    ...
    { static int _cla_dv_1[4] = {1,  0,  2,  4};
    ach = _cla_dv_1[stype]; }
...
static int dv_extract_video_info(DVDemuxContext *c, uint8_t* frame)
{
    ...
    if (c->sys) {
        ...
        avctx->bit_rate = av_rescale_q(c->sys->frame_size, av_make_q(8, 1),
                                       c->sys->time_base);
...
void ff_dv_offset_reset(DVDemuxContext *c, int64_t frame_offset)
{
    ...
    if (c->ach) {
        ...
        c->abytes= av_rescale_q(c->frames, c->sys->time_base,
                                av_make_q(8, c->ast[0]->codec->bit_rate));
        }else
...
static int dv_read_header(AVFormatContext *s)
{
    ...
    s->bit_rate = av_rescale_q(c->dv_demux->sys->frame_size, av_make_q(8, 1),
...
AVInputFormat ff_dv_demuxer = {
    ...
    0, /* next */
    0, /* raw_codec_id */
    sizeof(RawDVContext), /* priv_data_size */
    dv_probe, /* read_probe */
    dv_read_header, /* read_header */
    dv_read_packet, /* read_packet */
    dv_read_close, /* read_close */
    dv_read_seek, /* read_seek */
};
#endif
