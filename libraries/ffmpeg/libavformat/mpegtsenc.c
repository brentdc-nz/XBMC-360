...
static const AVOption options[] = {
    ...
    { "mpegts_pmt_start_pid", "Set the first pid of the PMT.",
      offsetof(MpegTSWrite, pmt_start_pid), AV_OPT_TYPE_INT, { 0x1000 }, 0x0010, 0x1f00, AV_OPT_FLAG_ENCODING_PARAM},
    { "mpegts_start_pid", "Set the first pid.",
      offsetof(MpegTSWrite, start_pid), AV_OPT_TYPE_INT, { 0x0100 }, 0x0100, 0x0f00, AV_OPT_FLAG_ENCODING_PARAM},
    {"mpegts_m2ts_mode", "Enable m2ts mode.",
        offsetof(MpegTSWrite, m2ts_mode), AV_OPT_TYPE_INT, { -1 },
...
AVOutputFormat ff_mpegts_muxer = {
    "mpegts", /* name */
    NULL_IF_CONFIG_SMALL("MPEG-TS (MPEG-2 Transport Stream)"), /* long_name */
    "video/x-mpegts", /* mime_type */
    "ts,m2t,m2ts,mts", /* extensions */
    AV_CODEC_ID_MP2, /* audio_codec */
    AV_CODEC_ID_MPEG2VIDEO, /* video_codec */
    0, /* subtitle_codec */
    AVFMT_ALLOW_FLUSH, /* flags */
    0, /* codec_tag */
    &mpegts_muxer_class, /* priv_class */
    0, /* next */
    sizeof(MpegTSWrite), /* priv_data_size */
    mpegts_write_header, /* write_header */
    mpegts_write_packet, /* write_packet */
    mpegts_write_end, /* write_trailer */
};
