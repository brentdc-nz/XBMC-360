...
AVOutputFormat ff_ico_muxer = {
    "ico", /* name */
    NULL_IF_CONFIG_SMALL("Microsoft Windows ICO"), /* long_name */
    "image/vnd.microsoft.icon", /* mime_type */
    "ico", /* extensions */
    AV_CODEC_ID_NONE, /* audio_codec */
    AV_CODEC_ID_BMP, /* video_codec */
    0, /* subtitle_codec */
    AVFMT_NOTIMESTAMPS, /* flags */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    sizeof(IcoMuxContext), /* priv_data_size */
    ico_write_header, /* write_header */
    ico_write_packet, /* write_packet */
    ico_write_trailer, /* write_trailer */
};
