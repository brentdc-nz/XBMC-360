...
static const AVClass wav_demuxer_class = {
    "WAV demuxer", /* class_name */
    av_default_item_name, /* item_name */
    demux_options, /* option */
    LIBAVUTIL_VERSION_INT, /* version */
};
static const AVCodecTag *const _ff_wavdec_tags_40[] = { ff_codec_wav_tags, 0 };
AVInputFormat ff_wav_demuxer = {
    "wav", /* name */
    NULL_IF_CONFIG_SMALL("WAV / WAVE (Waveform Audio)"), /* long_name */
    AVFMT_GENERIC_INDEX, /* flags */
    0, /* extensions */
    _ff_wavdec_tags_40, /* codec_tag */
    &wav_demuxer_class, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(WAVDemuxContext), /* priv_data_size */
    wav_probe, /* read_probe */
    wav_read_header, /* read_header */
    wav_read_packet, /* read_packet */
    0, /* read_close */
    wav_read_seek, /* read_seek */
};
...
static const AVCodecTag *const _ff_wavdec_tags_41[] = { ff_codec_wav_tags, 0 };
AVInputFormat ff_w64_demuxer = {
    "w64", /* name */
    NULL_IF_CONFIG_SMALL("Sony Wave64"), /* long_name */
    AVFMT_GENERIC_INDEX, /* flags */
    0, /* extensions */
    _ff_wavdec_tags_41, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(WAVDemuxContext), /* priv_data_size */
    w64_probe, /* read_probe */
    w64_read_header, /* read_header */
    wav_read_packet, /* read_packet */
    0, /* read_close */
    wav_read_seek, /* read_seek */
};
