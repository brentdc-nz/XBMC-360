...
AVInputFormat ff_xmv_demuxer = {
    "xmv", /* name */
    NULL_IF_CONFIG_SMALL("Microsoft XMV"), /* long_name */
    0, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(XMVDemuxContext), /* priv_data_size */
    xmv_probe, /* read_probe */
    xmv_read_header, /* read_header */
    xmv_read_packet, /* read_packet */
    xmv_read_close, /* read_close */
};
