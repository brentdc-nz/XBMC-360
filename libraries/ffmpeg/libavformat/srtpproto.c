...
static const AVOption options[] = {
    { "srtp_out_suite", "", offsetof(SRTPProtoContext, out_suite), AV_OPT_TYPE_STRING, { 0, 0, NULL }, 0, 0, E },
    { "srtp_out_params", "", offsetof(SRTPProtoContext, out_params), AV_OPT_TYPE_STRING, { 0, 0, NULL }, 0, 0, E },
    { "srtp_in_suite", "", offsetof(SRTPProtoContext, in_suite), AV_OPT_TYPE_STRING, { 0, 0, NULL }, 0, 0, E },
    { "srtp_in_params", "", offsetof(SRTPProtoContext, in_params), AV_OPT_TYPE_STRING, { 0, 0, NULL }, 0, 0, E },
    { NULL }
};
...
URLProtocol ff_srtp_protocol = {
    ...
    srtp_open, /* url_open */
    srtp_read, /* url_read */
    srtp_write, /* url_write */
    0, /* url_seek */
    srtp_close, /* url_close */
    0, /* next */
    0, /* url_read_pause */
    0, /* url_read_seek */
    srtp_get_file_handle, /* url_get_file_handle */
    srtp_get_multi_file_handle, /* url_get_multi_file_handle */
    0, /* url_shutdown */
    sizeof(SRTPProtoContext), /* priv_data_size */
    &srtp_context_class, /* priv_data_class */
