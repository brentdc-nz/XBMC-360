                                   ...
                                   ff_asf_guid formattype, int size)
{
    ...
    if (!ff_guidcmp(subtype, ff_mediasubtype_cpfilters_processed) &&
        ...
        { static const uint8_t _cla_wtvdec_1[] = {FF_MEDIASUBTYPE_BASE_GUID};
        if (!memcmp(subtype + 4, _cla_wtvdec_1, 12)) {
        ...
        { static const uint8_t _cla_wtvdec_2[] = {FF_MEDIASUBTYPE_BASE_GUID};
        if (!memcmp(subtype + 4, _cla_wtvdec_2, 12)) {
 ...
 */
static const ff_asf_guid ff_wtv_guid_drm_protection = {0x83,0x95,0x74,0x40,0x9D,0x6B,0xEC,0x4E,0xB4,0x3C,0x67,0xA1,0x80,0x1E,0x1A,0x9B};
static const ff_asf_guid ff_wtv_guid_capture_streamtime = {0x14,0x56,0x1A,0x0C,0xCD,0x30,0x40,0x4F,0xBC,0xBF,0xD0,0x3E,0x52,0x30,0x62,0x07};
static const ff_asf_guid ff_wtv_guid_pbdatag_attribute = {0x79,0x66,0xB5,0xE0,0xB9,0x12,0xCC,0x43,0xB7,0xDF,0x57,0x8C,0xAA,0x5A,0x7B,0x63};
static const ff_asf_guid ff_wtv_guid_pic_sample_seq = {0x02,0xAE,0x5B,0x2F,0x8F,0x7B,0x60,0x4F,0x82,0xD6,0xE4,0xEA,0x2F,0x1F,0x4C,0x99};
static const ff_asf_guid ff_wtv_guid_vid_frame_rep = {0xCC,0x32,0x64,0xDD,0x29,0xE2,0xDB,0x40,0x80,0xF6,0xD2,0x63,0x28,0xD2,0x76,0x1F};
static const ff_asf_guid ff_wtv_guid_channel_change = {0xE5,0xC5,0x67,0x90,0x5C,0x4C,0x05,0x42,0x86,0xC8,0x7A,0xFE,0x20,0xFE,0x1E,0xFA};
static const ff_asf_guid ff_wtv_guid_channel_info = {0x80,0x6D,0xF3,0x41,0x32,0x41,0xC2,0x4C,0xB1,0x21,0x01,0xA4,0x32,0x19,0xD8,0x1B};
static const ff_asf_guid ff_wtv_guid_channel_type = {0x51,0x1D,0xAB,0x72,0xD2,0x87,0x9B,0x48,0xBA,0x11,0x0E,0x08,0xDC,0x21,0x02,0x43};
static const ff_asf_guid ff_wtv_guid_pid_list = {0x65,0x8F,0xFC,0x47,0xBB,0xE2,0x34,0x46,0x9C,0xEF,0xFD,0xBF,0xE6,0x26,0x1D,0x5C};
static const ff_asf_guid ff_wtv_guid_signal_status = {0xCB,0xC5,0x68,0x80,0x04,0x3C,0x2B,0x49,0xB4,0x7D,0x03,0x08,0x82,0x0D,0xCE,0x51};
static const ff_asf_guid ff_wtv_guid_stream_type = {0xBC,0x2E,0xAF,0x82,0xA6,0x30,0x64,0x42,0xA8,0x0B,0xAD,0x2E,0x13,0x72,0xAC,0x60};
static const ff_asf_guid ff_wtv_guid_unknown_1 = {0x1E,0xBE,0xC3,0xC5,0x43,0x92,0xDC,0x11,0x85,0xE5,0x00,0x12,0x3F,0x6F,0x73,0xB9};
static const ff_asf_guid ff_wtv_guid_unknown_2 = {0x3B,0x86,0xA2,0xB1,0xEB,0x1E,0xC3,0x44,0x8C,0x88,0x1C,0xA3,0xFF,0xE3,0xE7,0x6A};
static const ff_asf_guid ff_wtv_guid_unknown_3 = {0x4E,0x7F,0x4C,0x5B,0xC4,0xD0,0x38,0x4B,0xA8,0x3E,0x21,0x7F,0x7B,0xBF,0x52,0xE7};
static const ff_asf_guid ff_wtv_guid_unknown_4 = {0x63,0x36,0xEB,0xFE,0xA1,0x7E,0xD9,0x11,0x83,0x08,0x00,0x07,0xE9,0x5E,0xAD,0x8D};
static const ff_asf_guid ff_wtv_guid_unknown_5 = {0x70,0xE9,0xF1,0xF8,0x89,0xA4,0x4C,0x4D,0x83,0x73,0xB8,0x12,0xE0,0xD5,0xF8,0x1E};
static const ff_asf_guid ff_wtv_guid_unknown_6 = {0xF7,0x10,0x02,0xB9,0xEE,0x7C,0xED,0x4E,0xBD,0x7F,0x05,0x40,0x35,0x86,0x18,0xA1};
...
static int parse_chunks(AVFormatContext *s, int mode, int64_t seekts, int *len_ptr)
{
    ...
    while (!url_feof(pb)) {
        ...
        } else if (!ff_guidcmp(g, ff_wtv_guid_drm_protection)) {
            int stream_index = ff_find_stream_index(s, sid);
            if (stream_index >= 0)
                av_log(s, AV_LOG_WARNING, "encrypted stream detected (st:%d), decoding will likely fail\n", stream_index);
        } else if (
            !ff_guidcmp(g, ff_wtv_guid_capture_streamtime) ||
            !ff_guidcmp(g, ff_wtv_guid_pbdatag_attribute) ||
            !ff_guidcmp(g, ff_wtv_guid_pic_sample_seq) ||
            !ff_guidcmp(g, /* DSATTRIB_TRANSPORT_PROPERTIES */ ff_DSATTRIB_TRANSPORT_PROPERTIES) ||
            !ff_guidcmp(g, ff_wtv_guid_vid_frame_rep) ||
            !ff_guidcmp(g, ff_wtv_guid_channel_change) ||
            !ff_guidcmp(g, ff_wtv_guid_channel_info) ||
            !ff_guidcmp(g, ff_wtv_guid_channel_type) ||
            !ff_guidcmp(g, ff_wtv_guid_pid_list) ||
            !ff_guidcmp(g, ff_wtv_guid_signal_status) ||
            !ff_guidcmp(g, ff_wtv_guid_stream_type) ||
            !ff_guidcmp(g, ff_wtv_guid_unknown_1) ||
            !ff_guidcmp(g, ff_wtv_guid_unknown_2) ||
            !ff_guidcmp(g, ff_wtv_guid_unknown_3) ||
            !ff_guidcmp(g, ff_wtv_guid_unknown_4) ||
            !ff_guidcmp(g, ff_wtv_guid_unknown_5) ||
            !ff_guidcmp(g, ff_index_guid) ||
            !ff_guidcmp(g, ff_sync_guid) ||
            !ff_guidcmp(g, ff_stream1_guid) ||
            !ff_guidcmp(g, ff_wtv_guid_unknown_6)) {
            //ignore known guids
        } else
...
AVInputFormat ff_wtv_demuxer = {
    "wtv", /* name */
    NULL_IF_CONFIG_SMALL("Windows Television (WTV)"), /* long_name */
    AVFMT_SHOW_IDS, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(WtvContext), /* priv_data_size */
