...
AVInputFormat ff_bethsoftvid_demuxer = {
    "bethsoftvid", /* name */
    NULL_IF_CONFIG_SMALL("Bethesda Softworks VID"), /* long_name */
    0, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(BVID_DemuxContext), /* priv_data_size */
    vid_probe, /* read_probe */
    vid_read_header, /* read_header */
    vid_read_packet, /* read_packet */
    vid_read_close, /* read_close */
};
