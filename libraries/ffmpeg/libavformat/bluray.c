...
{"playlist", "", OFFSET(playlist), AV_OPT_TYPE_INT, { -1 }, -1,  99999, AV_OPT_FLAG_DECODING_PARAM },
{"angle",    "", OFFSET(angle),    AV_OPT_TYPE_INT, { 0 },   0,   0xfe, AV_OPT_FLAG_DECODING_PARAM },
{"chapter",  "", OFFSET(chapter),  AV_OPT_TYPE_INT, { 1 },   1, 0xfffe, AV_OPT_FLAG_DECODING_PARAM },
/*{"region",   "bluray player region code (1 = region A, 2 = region B, 4 = region C)", OFFSET(region), AV_OPT_TYPE_INT, { 0 }, 0, 3, AV_OPT_FLAG_DECODING_PARAM },*/
{NULL}
};
...
URLProtocol ff_bluray_protocol = {
    "bluray", /* name */
    bluray_open, /* url_open */
    bluray_read, /* url_read */
    0, /* url_write */
    bluray_seek, /* url_seek */
    bluray_close, /* url_close */
    0, /* next */
    0, /* url_read_pause */
    0, /* url_read_seek */
    ...
    0, /* url_shutdown */
    sizeof(BlurayContext), /* priv_data_size */
    &bluray_context_class, /* priv_data_class */
};
