...
AVOutputFormat ff_latm_muxer = {
    "latm", /* name */
    NULL_IF_CONFIG_SMALL("LOAS/LATM"), /* long_name */
    "audio/MP4A-LATM", /* mime_type */
    "latm,loas", /* extensions */
    AV_CODEC_ID_AAC, /* audio_codec */
    AV_CODEC_ID_NONE, /* video_codec */
    0, /* subtitle_codec */
    0, /* flags */
    0, /* codec_tag */
    &latm_muxer_class, /* priv_class */
    0, /* next */
    sizeof(LATMContext), /* priv_data_size */
    latm_write_header, /* write_header */
    latm_write_packet, /* write_packet */
};
