...
static int decode_stream_header(NUTContext *nut)
{
    ...
    {
        static const AVCodecTag *const _ff_nutdec_tags_26[] = { ff_nut_video_tags,
                                                            ff_codec_bmp_tags,
                                                            0 };
        static const AVCodecTag *const _ff_nutdec_tags_27[] = { ff_nut_audio_tags,
                                                            ff_codec_wav_tags,
                                                            0 };
        switch (class) {
        case 0:
            st->codec->codec_type = AVMEDIA_TYPE_VIDEO;
            st->codec->codec_id   = av_codec_get_id(_ff_nutdec_tags_26,
                                                    tmp);
            break;
        case 1:
            st->codec->codec_type = AVMEDIA_TYPE_AUDIO;
            st->codec->codec_id   = av_codec_get_id(_ff_nutdec_tags_27,
                                                    tmp);
            break;
    case 2:
                     ...
                     int64_t pts, int flags)
{
    ...
    Syncpoint dummy    = { pts * av_q2d(st->time_base) * AV_TIME_BASE };
    Syncpoint nopts_sp = { AV_NOPTS_VALUE, AV_NOPTS_VALUE };
...
AVInputFormat ff_nut_demuxer = {
    "nut", /* name */
    NULL_IF_CONFIG_SMALL("NUT"), /* long_name */
    AVFMT_SEEK_TO_PTS, /* flags */
    "nut", /* extensions */
    ff_nut_codec_tags, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
