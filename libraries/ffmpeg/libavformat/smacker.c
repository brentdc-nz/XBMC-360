...
AVInputFormat ff_smacker_demuxer = {
    "smk", /* name */
    NULL_IF_CONFIG_SMALL("Smacker"), /* long_name */
    0, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(SmackerContext), /* priv_data_size */
    smacker_probe, /* read_probe */
    smacker_read_header, /* read_header */
    smacker_read_packet, /* read_packet */
    smacker_read_close, /* read_close */
};
