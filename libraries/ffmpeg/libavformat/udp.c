...
{"localaddr", "Choose local IP address", OFFSET(local_addr), AV_OPT_TYPE_STRING, { 0 }, 0, 0, D|E },
...
URLProtocol ff_udp_protocol = {
    ...
    0, /* url_read_pause */
    0, /* url_read_seek */
    udp_get_file_handle, /* url_get_file_handle */
    0, /* url_get_multi_file_handle */
    0, /* url_shutdown */
    sizeof(UDPContext), /* priv_data_size */
    &udp_context_class, /* priv_data_class */
