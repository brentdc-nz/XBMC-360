...
AVInputFormat ff_amr_demuxer = {
    "amr", /* name */
    NULL_IF_CONFIG_SMALL("3GPP AMR"), /* long_name */
    ...
    0, /* raw_codec_id */
    0, /* priv_data_size */
    amr_probe, /* read_probe */
    amr_read_header, /* read_header */
    amr_read_packet, /* read_packet */
};
#endif
...
AVOutputFormat ff_amr_muxer = {
    ...
    0, /* next */
    0, /* priv_data_size */
    amr_write_header, /* write_header */
    amr_write_packet, /* write_packet */
};
#endif
