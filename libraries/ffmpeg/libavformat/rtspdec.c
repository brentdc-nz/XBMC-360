...
static const AVClass rtsp_demuxer_class = {
    "RTSP demuxer", /* class_name */
    av_default_item_name, /* item_name */
    ff_rtsp_options, /* option */
    LIBAVUTIL_VERSION_INT, /* version */
};

AVInputFormat ff_rtsp_demuxer = {
    "rtsp", /* name */
    NULL_IF_CONFIG_SMALL("RTSP input"), /* long_name */
    AVFMT_NOFILE, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    &rtsp_demuxer_class, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(RTSPState), /* priv_data_size */
    rtsp_probe, /* read_probe */
    rtsp_read_header, /* read_header */
    rtsp_read_packet, /* read_packet */
    rtsp_read_close, /* read_close */
    rtsp_read_seek, /* read_seek */
    0, /* read_timestamp */
    rtsp_read_play, /* read_play */
    rtsp_read_pause, /* read_pause */
};
