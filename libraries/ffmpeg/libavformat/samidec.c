...
AVInputFormat ff_sami_demuxer = {
    "sami", /* name */
    NULL_IF_CONFIG_SMALL("SAMI subtitle format"), /* long_name */
    0, /* flags */
    "smi,sami", /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(SAMIContext), /* priv_data_size */
    sami_probe, /* read_probe */
    sami_read_header, /* read_header */
    sami_read_packet, /* read_packet */
    sami_read_close, /* read_close */
    0, /* read_seek */
    0, /* read_timestamp */
    0, /* read_play */
    0, /* read_pause */
    sami_read_seek, /* read_seek2 */
};
