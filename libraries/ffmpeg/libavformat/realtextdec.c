...
AVInputFormat ff_realtext_demuxer = {
    "realtext", /* name */
    NULL_IF_CONFIG_SMALL("RealText subtitle format"), /* long_name */
    0, /* flags */
    "rt", /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(RealTextContext), /* priv_data_size */
    realtext_probe, /* read_probe */
    realtext_read_header, /* read_header */
    realtext_read_packet, /* read_packet */
    realtext_read_close, /* read_close */
    0, /* read_seek */
    0, /* read_timestamp */
    0, /* read_play */
    0, /* read_pause */
    realtext_read_seek, /* read_seek2 */
};
