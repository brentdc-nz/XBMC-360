...
AVInputFormat ff_subviewer_demuxer = {
    "subviewer", /* name */
    NULL_IF_CONFIG_SMALL("SubViewer subtitle format"), /* long_name */
    0, /* flags */
    "sub", /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(SubViewerContext), /* priv_data_size */
    subviewer_probe, /* read_probe */
    subviewer_read_header, /* read_header */
    subviewer_read_packet, /* read_packet */
    subviewer_read_close, /* read_close */
    0, /* read_seek */
    0, /* read_timestamp */
    0, /* read_play */
    0, /* read_pause */
    subviewer_read_seek, /* read_seek2 */
};
