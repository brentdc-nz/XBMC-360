...
AVInputFormat ff_gsm_demuxer = {
    "gsm", /* name */
    NULL_IF_CONFIG_SMALL("raw GSM"), /* long_name */
    AVFMT_GENERIC_INDEX, /* flags */
    "gsm", /* extensions */
    0, /* codec_tag */
    &class, /* priv_class */
    0, /* next */
    AV_CODEC_ID_GSM, /* raw_codec_id */
    sizeof(GSMDemuxerContext), /* priv_data_size */
    0, /* read_probe */
    gsm_read_header, /* read_header */
    gsm_read_packet, /* read_packet */
};
