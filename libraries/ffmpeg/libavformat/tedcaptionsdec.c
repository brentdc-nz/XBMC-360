...
AVInputFormat ff_tedcaptions_demuxer = {
    "tedcaptions", /* name */
    NULL_IF_CONFIG_SMALL("TED Talks captions"), /* long_name */
    0, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    &tedcaptions_demuxer_class, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(TEDCaptionsDemuxer), /* priv_data_size */
    tedcaptions_read_probe, /* read_probe */
    tedcaptions_read_header, /* read_header */
    tedcaptions_read_packet, /* read_packet */
    tedcaptions_read_close, /* read_close */
    0, /* read_seek */
    0, /* read_timestamp */
    0, /* read_play */
    0, /* read_pause */
    tedcaptions_read_seek, /* read_seek2 */
};
