...
AVOutputFormat ff_dv_muxer = {
    ...
    AV_CODEC_ID_DVVIDEO, /* video_codec */
    0, /* subtitle_codec */
    0, /* flags */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    sizeof(DVMuxContext), /* priv_data_size */
    dv_write_header, /* write_header */
    dv_write_packet, /* write_packet */
    dv_write_trailer, /* write_trailer */
};
