...
static const AVClass ism_class = {
    "smooth streaming muxer", /* class_name */
...
static const AVCodecTag *const _ff_smoothstreamingenc_tags_34[] = { ff_mp4_obj_type, 0 };
AVOutputFormat ff_smoothstreaming_muxer = {
    "smoothstreaming", /* name */
    NULL_IF_CONFIG_SMALL("Smooth Streaming Muxer"), /* long_name */
    0, /* mime_type */
    0, /* extensions */
    AV_CODEC_ID_AAC, /* audio_codec */
    AV_CODEC_ID_H264, /* video_codec */
    0, /* subtitle_codec */
    AVFMT_GLOBALHEADER | AVFMT_NOFILE, /* flags */
    _ff_smoothstreamingenc_tags_34, /* codec_tag */
    &ism_class, /* priv_class */
    0, /* next */
    sizeof(SmoothStreamingContext), /* priv_data_size */
    ism_write_header, /* write_header */
    ism_write_packet, /* write_packet */
    ism_write_trailer, /* write_trailer */
};
