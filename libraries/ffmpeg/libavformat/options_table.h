...
{"aggressive", "consider things that a sane encoder shouldnt do as an error", 0, AV_OPT_TYPE_CONST, { AV_EF_AGGRESSIVE }, INT_MIN, INT_MAX, D, "err_detect"},
...
{"avoid_negative_ts", "shift timestamps to make them positive. 1 enables, 0 disables, default of -1 enables when required by target format.", OFFSET(avoid_negative_ts), AV_OPT_TYPE_INT, { -1 }, -1, 1, E},
