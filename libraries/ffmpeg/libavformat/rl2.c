...
AVInputFormat ff_rl2_demuxer = {
    "rl2", /* name */
    NULL_IF_CONFIG_SMALL("RL2"), /* long_name */
    0, /* flags */
    0, /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(Rl2DemuxContext), /* priv_data_size */
    rl2_probe, /* read_probe */
    rl2_read_header, /* read_header */
    rl2_read_packet, /* read_packet */
    0, /* read_close */
    rl2_read_seek, /* read_seek */
};
