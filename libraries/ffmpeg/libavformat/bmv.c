...
AVInputFormat ff_bmv_demuxer = {
    "bmv", /* name */
    NULL_IF_CONFIG_SMALL("Discworld II BMV"), /* long_name */
    0, /* flags */
    "bmv", /* extensions */
    0, /* codec_tag */
    0, /* priv_class */
    0, /* next */
    0, /* raw_codec_id */
    sizeof(BMVContext), /* priv_data_size */
    0, /* read_probe */
    bmv_read_header, /* read_header */
    bmv_read_packet, /* read_packet */
    bmv_read_close, /* read_close */
};
