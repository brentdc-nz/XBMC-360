...
static int write_number(void *obj, const AVOption *o, void *dst, double num, int den, int64_t intnum)
{
    ...
    case AV_OPT_TYPE_RATIONAL:
        if ((int)num == num) *(AVRational*)dst= av_make_q(num*intnum, den);
...
{"rational", "set rational",   OFFSET(rational), AV_OPT_TYPE_RATIONAL, { 0, 0 },       0,        10                  },
...
{"pix_fmt",  "set pixfmt",     OFFSET(pix_fmt),  AV_OPT_TYPE_PIXEL_FMT, { AV_PIX_FMT_NONE }, -1, AV_PIX_FMT_NB-1},
{"sample_fmt", "set samplefmt", OFFSET(sample_fmt), AV_OPT_TYPE_SAMPLE_FMT, { AV_SAMPLE_FMT_NONE }, -1, AV_SAMPLE_FMT_NB-1},
{NULL},
};
