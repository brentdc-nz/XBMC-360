...
bool CGUIDialogNumeric::ShowAndGetSeconds(CStdString &timeString, const CStdString &heading)
{
	...
	int seconds = CStringUtils::TimeStringToSeconds(timeString);
	...
	timeString = CStringUtils::SecondsToTimeString(seconds);
...
// Show numeric keypad twice to get and confirm a user-entered password string.
...
// Show numeric keypad and verify user input against strPassword.
...
// Show numeric keypad and verify user input against strToVerify.
