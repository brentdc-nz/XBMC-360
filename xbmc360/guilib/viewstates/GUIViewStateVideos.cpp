...
CGUIViewStateWindowVideos::CGUIViewStateWindowVideos(const CFileItemList& items) : CGUIViewState(items) // TODO : Check same as the real version
{
/*
...
VECSOURCES& CGUIViewStateWindowVideos::GetShares()
{
	return *g_settings.GetSourcesFromType("videos");
}

CStdString CGUIViewStateWindowVideos::GetExtensions()
{
